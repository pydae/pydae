...
class model: 
    ...
    def __init__(self): 
        ...
        self.y_run_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_si_1', 'i_sr_1', 'p_s_1', 'q_s_1', 'i_sd_ref_1', 'i_sq_ref_1', 'v_td_ref_1', 'v_tq_ref_1', 'm_1', 'theta_t_1', 'omega_2', 'i_d_2', 'i_q_2', 'p_s_2', 'q_s_2', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_si_1', 'i_sr_1', 'p_s_1', 'q_s_1', 'i_sd_ref_1', 'i_sq_ref_1', 'v_td_ref_1', 'v_tq_ref_1', 'm_1', 'theta_t_1', 'omega_2', 'i_d_2', 'i_q_2', 'p_s_2', 'q_s_2', 'omega_coi', 'p_agc'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 16, 1, 18, 23, 2, 3, 23, 4, 5, 6, 7, 10, 4, 5, 6, 7, 11, 4, 5, 6, 7, 21, 4, 5, 6, 7, 22, 4, 5, 8, 9, 16, 17, 4, 5, 8, 9, 16, 17, 4, 5, 8, 9, 10, 4, 5, 8, 9, 11, 4, 13, 4, 12, 12, 13, 14, 4, 12, 13, 15, 5, 14, 15, 16, 5, 14, 15, 17, 2, 18, 1, 6, 7, 19, 20, 1, 6, 7, 19, 20, 1, 6, 7, 19, 20, 21, 1, 6, 7, 19, 20, 22, 18, 23, 3, 23, 24]
    sp_jac_ini_ja = [0, 2, 5, 6, 8, 13, 18, 23, 28, 34, 40, 45, 50, 52, 54, 57, 61, 65, 69, 71, 76, 81, 87, 93, 95, 98]
    sp_jac_ini_nia = 25
    sp_jac_ini_nja = 25
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 16, 1, 18, 23, 2, 3, 23, 4, 5, 6, 7, 10, 4, 5, 6, 7, 11, 4, 5, 6, 7, 21, 4, 5, 6, 7, 22, 4, 5, 8, 9, 16, 17, 4, 5, 8, 9, 16, 17, 4, 5, 8, 9, 10, 4, 5, 8, 9, 11, 4, 13, 4, 12, 12, 13, 14, 4, 12, 13, 15, 5, 14, 15, 16, 5, 14, 15, 17, 2, 18, 1, 6, 7, 19, 20, 1, 6, 7, 19, 20, 1, 6, 7, 19, 20, 21, 1, 6, 7, 19, 20, 22, 18, 23, 3, 23, 24]
    sp_jac_run_ja = [0, 2, 5, 6, 8, 13, 18, 23, 28, 34, 40, 45, 50, 52, 54, 57, 61, 65, 69, 71, 76, 81, 87, 93, 95, 98]
    sp_jac_run_nia = 25
    sp_jac_run_nja = 25
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 16, 1, 18, 23, 2, 3, 23, 4, 5, 6, 7, 10, 4, 5, 6, 7, 11, 4, 5, 6, 7, 21, 4, 5, 6, 7, 22, 4, 5, 8, 9, 16, 17, 4, 5, 8, 9, 16, 17, 4, 5, 8, 9, 10, 4, 5, 8, 9, 11, 4, 13, 4, 12, 12, 13, 14, 4, 12, 13, 15, 5, 14, 15, 16, 5, 14, 15, 17, 2, 18, 1, 6, 7, 19, 20, 1, 6, 7, 19, 20, 1, 6, 7, 19, 20, 21, 1, 6, 7, 19, 20, 22, 18, 23, 3, 23, 24]
    sp_jac_trap_ja = [0, 2, 5, 6, 8, 13, 18, 23, 28, 34, 40, 45, 50, 52, 54, 57, 61, 65, 69, 71, 76, 81, 87, 93, 95, 98]
    sp_jac_trap_nia = 25
    sp_jac_trap_nja = 25
