...
data[61] = -0.25*Dt*(-u[2]*y[0]*cos(x[0] - u[3]) + u[2]*y[1]*sin(x[0] - u[3]))/p[9]; 
data[61] = -0.25*Dt*(-2*p[7]*y[0] - u[2]*sin(x[0] - u[3]))/p[9]; 
data[61] = -0.25*Dt*(-2*p[7]*y[1] - u[2]*cos(x[0] - u[3]))/p[9]; 
data[61] = -u[2]*sin(x[0] - u[3]); 
data[61] = u[2]*cos(x[0] - u[3]); 
data[61] = u[2]*y[0]*cos(x[0] - u[3]) - u[2]*y[1]*sin(x[0] - u[3]); 
data[61] = u[2]*sin(x[0] - u[3]); 
data[61] = u[2]*cos(x[0] - u[3]); 
data[61] = -u[2]*y[0]*sin(x[0] - u[3]) - u[2]*y[1]*cos(x[0] - u[3]); 
data[61] = u[2]*cos(x[0] - u[3]); 
data[61] = -u[2]*sin(x[0] - u[3]); 
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_dae_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_dae_cffi(void) { return NULL; }
#  else
     initdae_cffi(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_dae_cffi(void)
{
  return _cffi_init("dae_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initdae_cffi(void)
{
  _cffi_init("dae_cffi", 0x2601, &_cffi_type_context);
}
#endif
