...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_pv_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_pv_cffi(void) { return NULL; }
#  else
     initpv_cffi(void) { }
#  endif
#  endif
...
PyInit_pv_cffi(void)
{
  return _cffi_init("pv_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initpv_cffi(void)
{
  _cffi_init("pv_cffi", 0x2601, &_cffi_type_context);
}
#endif
