...
out[3] = -p[7]/p[8] - 1.0 - 38.89108321788833*p[7]*(p[0] - (-0.001*p[0]*p[7]*u[1]*(0.01*p[6]*(u[2] - 25.0) + 1.0) + p[5]*(u[2] - 25.0) + p[3])/p[8])*exp(38.89108321788833*(-p[5]*(u[2] - 25.0) - p[3])/(p[9]*p[4]))*exp(38.89108321788833*(p[7]*y[0] + u[0])/(p[9]*p[4]))/(p[9]*p[4]);
