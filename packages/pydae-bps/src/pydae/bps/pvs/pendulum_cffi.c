...
out[0] = -y[0] + (1.0/1000.0)*u[1]*((p[0] - (-1.0/1000.0*p[0]*R_s_*u[1]*((1.0/100.0)*p[6]*(u[2] - 25.0) + 1) + p[5]*(u[2] - 25.0) + p[3])/R_sh_)*exp(38.89108321788833*(-p[5]*(u[2] - 25.0) - p[3])/(K_d_*p[4]))*exp(38.89108321788833*(p[5]*(u[2] - 25.0) + p[3])/(K_d_*p[4])) + (p[5]*(u[2] - 25.0) + p[3])/R_sh_) - (p[0] - (-1.0/1000.0*p[0]*R_s_*u[1]*((1.0/100.0)*p[6]*(u[2] - 25.0) + 1) + p[5]*(u[2] - 25.0) + p[3])/R_sh_)*(exp(38.89108321788833*(R_s_*y[0] + u[0])/(K_d_*p[4])) - 1)*exp(38.89108321788833*(-p[5]*(u[2] - 25.0) - p[3])/(K_d_*p[4])) - (R_s_*y[0] + u[0])/R_sh_;
...
out[0] = (1.0/1000.0)*u[1]*((p[0] - (-1.0/1000.0*p[0]*R_s_*u[1]*((1.0/100.0)*p[6]*(u[2] - 25.0) + 1) + p[5]*(u[2] - 25.0) + p[3])/R_sh_)*exp(38.89108321788833*(-p[5]*(u[2] - 25.0) - p[3])/(K_d_*p[4]))*exp(38.89108321788833*(p[5]*(u[2] - 25.0) + p[3])/(K_d_*p[4])) + (p[5]*(u[2] - 25.0) + p[3])/R_sh_);

}
void de_jac_ini_xy_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[3] = -R_s_/R_sh_ - 1.0 - 38.89108321788833*R_s_*(p[0] - (-0.001*p[0]*R_s_*u[1]*(0.01*p[6]*(u[2] - 25.0) + 1.0) + p[5]*(u[2] - 25.0) + p[3])/R_sh_)*exp(38.89108321788833*(-p[5]*(u[2] - 25.0) - p[3])/(K_d_*p[4]))*exp(38.89108321788833*(R_s_*y[0] + u[0])/(K_d_*p[4]))/(K_d_*p[4]);
...
out[1] = -R_s_/R_sh_ - 1.0 - 38.89108321788833*R_s_*(p[0] - (-0.001*p[0]*R_s_*u[1]*(0.01*p[6]*(u[2] - 25.0) + 1.0) + p[5]*(u[2] - 25.0) + p[3])/R_sh_)*exp(38.89108321788833*(-p[5]*(u[2] - 25.0) - p[3])/(K_d_*p[4]))*exp(38.89108321788833*(R_s_*y[0] + u[0])/(K_d_*p[4]))/(K_d_*p[4]);
