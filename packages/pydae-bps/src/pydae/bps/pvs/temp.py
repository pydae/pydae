...
class model: 
    ...
    def __init__(self,matrices_folder='./build'): 
        ...
        self.N_z = 11 
        self.N_store = 100000 
        self.params_list = ['S_base', 'g_1_2', 'b_1_2', 'bs_1_2', 'U_1_n', 'U_2_n', 'S_n_2', 'F_n_2', 'X_v_2', 'R_v_2', 'K_delta_2', 'K_alpha_2', 'K_rocov_2', 'I_sc_1', 'I_mp_1', 'V_mp_1', 'V_oc_1', 'N_pv_s_1', 'N_pv_p_1', 'K_vt_1', 'K_it_1', 'A_00_pq_1', 'A_01_pq_1', 'A_02_pq_1', 'A_03_pq_1', 'A_10_pq_1', 'A_11_pq_1', 'A_12_pq_1', 'A_13_pq_1', 'A_20_pq_1', 'A_21_pq_1', 'A_22_pq_1', 'A_23_pq_1', 'A_30_pq_1', 'A_31_pq_1', 'A_32_pq_1', 'A_33_pq_1', 'B_00_pq_1', 'B_01_pq_1', 'B_10_pq_1', 'B_11_pq_1', 'B_20_pq_1', 'B_21_pq_1', 'B_30_pq_1', 'B_31_pq_1', 'C_00_pq_1', 'C_01_pq_1', 'C_02_pq_1', 'C_03_pq_1', 'C_10_pq_1', 'C_11_pq_1', 'C_12_pq_1', 'C_13_pq_1', 'D_00_pq_1', 'D_01_pq_1', 'D_10_pq_1', 'D_11_pq_1', 'v_lvrt_1', 'S_n_1', 'F_n_1', 'U_n_1', 'X_s_1', 'R_s_1', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [100000000.0, 0.0, -2000.0000000000002, 0.0, 20000.0, 20000.0, 10000000000.0, 50.0, 0.001, 0.0, 0.001, 1e-06, 1e-06, 8, 3.56, 33.7, 42.1, 23, 1087, -0.16, 0.065, 2.22745959, 2.89134367, 0.0, 0.0, -5.98640302, -5.13853719, 0.0, 0.0, 0.0, 0.0, 2.22745959, 2.89134367, 0.0, 0.0, -5.98640302, -5.13853719, -2.62892537, 0.0, -3.35747765, 0.0, 0.0, -2.62892537, 0.0, -3.35747765, -0.53183608, -0.28013641, 0.0, 0.0, 0.0, 0.0, -0.53183608, -0.28013641, 0.0, 0.0, 0.0, 0.0, 0.8, 3000000.0, 50.0, 400.0, 0.1, 0.0001, 0.0, 0.0, 0.01] 
        ...
        self.outputs_list = ['V_1', 'V_2', 'alpha_2', 'Dv_2', 'theta_v_2', 'm_ref_1', 'v_sd_1', 'v_sq_1', 'lvrt_1', 'p_s_ppc_1', 'q_s_ppc_1'] 
        self.x_list = ['delta_2', 'Domega_2', 'Dv_2', 'x_0_pq_1', 'x_1_pq_1', 'x_2_pq_1', 'x_3_pq_1', 'xi_freq'] 
        self.y_run_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'omega_2', 'v_dc_1', 'i_sq_ref_1', 'i_sd_ref_1', 'i_sr_1', 'i_si_1', 'p_s_1', 'q_s_1', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'omega_2', 'v_dc_1', 'i_sq_ref_1', 'i_sd_ref_1', 'i_sr_1', 'i_si_1', 'p_s_1', 'q_s_1', 'omega_coi', 'p_agc'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 12, 20, 1, 2, 3, 4, 5, 6, 3, 4, 5, 6, 3, 4, 5, 6, 3, 4, 5, 6, 7, 20, 8, 9, 10, 11, 18, 8, 9, 10, 11, 19, 0, 2, 8, 9, 10, 11, 0, 2, 8, 9, 10, 11, 1, 12, 13, 18, 3, 4, 5, 6, 8, 15, 3, 4, 5, 6, 8, 14, 8, 9, 14, 15, 16, 17, 8, 9, 14, 15, 16, 17, 8, 9, 16, 17, 18, 8, 9, 16, 17, 19, 12, 20, 7, 20, 21]
    sp_jac_ini_ja = [0, 3, 4, 5, 9, 13, 17, 21, 23, 28, 33, 39, 45, 47, 49, 55, 61, 67, 73, 78, 83, 85, 88]
    sp_jac_ini_nia = 22
    sp_jac_ini_nja = 22
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 12, 20, 1, 2, 3, 4, 5, 6, 3, 4, 5, 6, 3, 4, 5, 6, 3, 4, 5, 6, 7, 20, 8, 9, 10, 11, 18, 8, 9, 10, 11, 19, 0, 2, 8, 9, 10, 11, 0, 2, 8, 9, 10, 11, 1, 12, 13, 18, 3, 4, 5, 6, 8, 15, 3, 4, 5, 6, 8, 14, 8, 9, 14, 15, 16, 17, 8, 9, 14, 15, 16, 17, 8, 9, 16, 17, 18, 8, 9, 16, 17, 19, 12, 20, 7, 20, 21]
    sp_jac_run_ja = [0, 3, 4, 5, 9, 13, 17, 21, 23, 28, 33, 39, 45, 47, 49, 55, 61, 67, 73, 78, 83, 85, 88]
    sp_jac_run_nia = 22
    sp_jac_run_nja = 22
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 12, 20, 1, 2, 3, 4, 5, 6, 3, 4, 5, 6, 3, 4, 5, 6, 3, 4, 5, 6, 7, 20, 8, 9, 10, 11, 18, 8, 9, 10, 11, 19, 0, 2, 8, 9, 10, 11, 0, 2, 8, 9, 10, 11, 1, 12, 13, 18, 3, 4, 5, 6, 8, 15, 3, 4, 5, 6, 8, 14, 8, 9, 14, 15, 16, 17, 8, 9, 14, 15, 16, 17, 8, 9, 16, 17, 18, 8, 9, 16, 17, 19, 12, 20, 7, 20, 21]
    sp_jac_trap_ja = [0, 3, 4, 5, 9, 13, 17, 21, 23, 28, 33, 39, 45, 47, 49, 55, 61, 67, 73, 78, 83, 85, 88]
    sp_jac_trap_nia = 22
    sp_jac_trap_nja = 22
