...
out[0] = 6.2831853071795862*p[7]*(y[4] - y[13]) - p[10]*(x[0] - u[7]);
out[1] = -x[1]*p[11] + u[4];
out[2] = -x[2]*p[12] + u[9];
out[3] = 1.0*(u[10] - x[3])/p[13];
out[4] = 1.0*(u[11] - x[4])/p[14];
out[5] = -p[17]*x[5] - y[13] + 1;

}
void g_ini_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[0] = -u[0]/p[0] + pow(y[0], 2)*p[1] + y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) - p[6]*y[7]/p[0];
out[1] = -u[1]/p[0] + pow(y[0], 2)*(-p[2] - 1.0/2.0*p[3]) + y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3])) - p[6]*y[8]/p[0];
out[2] = -u[2]/p[0] + y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + pow(y[2], 2)*p[1] + u[12] + u[14] + x[3];
out[3] = -u[3]/p[0] + y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + pow(y[2], 2)*(-p[2] - 1.0/2.0*p[3]) + u[13] + u[15] + x[4];
out[4] = x[1] - y[4] + u[6];
out[5] = -p[9]*y[5] - y[0]*sin(x[0] + u[8] - y[1]) + p[8]*y[6];
out[6] = x[2] - p[9]*y[6] - y[0]*cos(x[0] + u[8] - y[1]) - p[8]*y[5] + u[5];
out[7] = y[0]*y[5]*sin(x[0] + u[8] - y[1]) + y[0]*y[6]*cos(x[0] + u[8] - y[1]) - y[7];
out[8] = y[0]*y[5]*cos(x[0] + u[8] - y[1]) - y[0]*y[6]*sin(x[0] + u[8] - y[1]) - y[8];
out[9] = y[2]*y[9] - u[12];
out[10] = y[2]*y[10] - u[13];
out[11] = pow(y[2], 2)*y[11] - u[10];
out[12] = pow(y[2], 2)*y[12] - u[11];
out[13] = 1.0*y[4] - y[13];
out[14] = p[16]*x[5] + p[15]*(1 - y[13]) - y[14];
...
out[1] = -x[1]*p[11] + u[4];
out[2] = -x[2]*p[12] + u[9];
out[3] = 1.0*(y[11] - x[3])/p[13];
out[4] = 1.0*(y[12] - x[4])/p[14];
out[5] = -p[17]*x[5] - y[13] + 1;
...
out[0] = -u[0]/p[0] + pow(y[0], 2)*p[1] + y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) - p[6]*y[7]/p[0];
out[1] = -u[1]/p[0] + pow(y[0], 2)*(-p[2] - 1.0/2.0*p[3]) + y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3])) - p[6]*y[8]/p[0];
out[2] = -u[2]/p[0] + y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + pow(y[2], 2)*p[1] + y[9] + u[14] + x[3];
out[3] = -u[3]/p[0] + y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + pow(y[2], 2)*(-p[2] - 1.0/2.0*p[3]) + y[10] + u[15] + x[4];
out[4] = x[1] - y[4] + u[6];
out[5] = -p[9]*y[5] - y[0]*sin(x[0] + u[8] - y[1]) + p[8]*y[6];
out[6] = x[2] - p[9]*y[6] - y[0]*cos(x[0] + u[8] - y[1]) - p[8]*y[5] + u[5];
out[7] = y[0]*y[5]*sin(x[0] + u[8] - y[1]) + y[0]*y[6]*cos(x[0] + u[8] - y[1]) - y[7];
out[8] = y[0]*y[5]*cos(x[0] + u[8] - y[1]) - y[0]*y[6]*sin(x[0] + u[8] - y[1]) - y[8];
out[9] = y[2]*u[12] - y[9];
out[10] = y[2]*u[13] - y[10];
out[11] = pow(y[2], 2)*u[10] - y[11];
out[12] = pow(y[2], 2)*u[11] - y[12];
out[13] = 1.0*y[4] - y[13];
out[14] = p[16]*x[5] + p[15]*(1 - y[13]) - y[14];
...
out[2] = u[4];
out[3] = x[2];
out[4] = p[0]*(-y[9] - u[14] - x[3]);
out[5] = p[0]*(-y[10] - u[15] - x[4]);

}
void de_jac_ini_xy_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[132] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[133] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[134] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[135] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[153] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[154] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[155] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[156] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[174] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[175] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[176] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[177] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[195] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[196] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[197] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
out[198] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[231] = -y[0]*cos(x[0] + u[8] - y[1]);
out[237] = -sin(x[0] + u[8] - y[1]);
out[238] = y[0]*cos(x[0] + u[8] - y[1]);
out[252] = y[0]*sin(x[0] + u[8] - y[1]);
out[258] = -cos(x[0] + u[8] - y[1]);
out[259] = -y[0]*sin(x[0] + u[8] - y[1]);
out[273] = y[0]*y[5]*cos(x[0] + u[8] - y[1]) - y[0]*y[6]*sin(x[0] + u[8] - y[1]);
out[279] = y[5]*sin(x[0] + u[8] - y[1]) + y[6]*cos(x[0] + u[8] - y[1]);
out[280] = -y[0]*y[5]*cos(x[0] + u[8] - y[1]) + y[0]*y[6]*sin(x[0] + u[8] - y[1]);
out[284] = y[0]*sin(x[0] + u[8] - y[1]);
out[285] = y[0]*cos(x[0] + u[8] - y[1]);
out[294] = -y[0]*y[5]*sin(x[0] + u[8] - y[1]) - y[0]*y[6]*cos(x[0] + u[8] - y[1]);
out[300] = y[5]*cos(x[0] + u[8] - y[1]) - y[6]*sin(x[0] + u[8] - y[1]);
out[301] = y[0]*y[5]*sin(x[0] + u[8] - y[1]) + y[0]*y[6]*cos(x[0] + u[8] - y[1]);
out[305] = y[0]*cos(x[0] + u[8] - y[1]);
out[306] = -y[0]*sin(x[0] + u[8] - y[1]);
out[323] = y[9];
out[330] = y[2];
out[344] = y[10];
out[352] = y[2];
out[365] = 2.0*y[2]*y[11];
out[374] = pow(y[2], 2);
out[386] = 2.0*y[2]*y[12];
out[396] = pow(y[2], 2);
...
out[0] = -p[10];
out[10] = 6.2831853071795862*p[7];
out[19] = -6.2831853071795862*p[7];
out[22] = -p[11];
out[44] = -p[12];
out[66] = -1.0/p[13];
out[88] = -1.0/p[14];
...
out[9] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[10] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[11] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[12] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[14] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[15] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[16] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[17] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[20] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[21] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[22] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
...
out[27] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
out[28] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[31] = -y[0]*cos(x[0] + u[8] - y[1]);
out[32] = -sin(x[0] + u[8] - y[1]);
out[33] = y[0]*cos(x[0] + u[8] - y[1]);
out[36] = y[0]*sin(x[0] + u[8] - y[1]);
out[38] = -cos(x[0] + u[8] - y[1]);
out[39] = -y[0]*sin(x[0] + u[8] - y[1]);
out[42] = y[0]*y[5]*cos(x[0] + u[8] - y[1]) - y[0]*y[6]*sin(x[0] + u[8] - y[1]);
out[43] = y[5]*sin(x[0] + u[8] - y[1]) + y[6]*cos(x[0] + u[8] - y[1]);
out[44] = -y[0]*y[5]*cos(x[0] + u[8] - y[1]) + y[0]*y[6]*sin(x[0] + u[8] - y[1]);
out[45] = y[0]*sin(x[0] + u[8] - y[1]);
out[46] = y[0]*cos(x[0] + u[8] - y[1]);
out[48] = -y[0]*y[5]*sin(x[0] + u[8] - y[1]) - y[0]*y[6]*cos(x[0] + u[8] - y[1]);
out[49] = y[5]*cos(x[0] + u[8] - y[1]) - y[6]*sin(x[0] + u[8] - y[1]);
out[50] = y[0]*y[5]*sin(x[0] + u[8] - y[1]) + y[0]*y[6]*cos(x[0] + u[8] - y[1]);
out[51] = y[0]*cos(x[0] + u[8] - y[1]);
out[52] = -y[0]*sin(x[0] + u[8] - y[1]);
out[54] = y[9];
out[55] = y[2];
out[56] = y[10];
out[57] = y[2];
...
out[305] = y[0]*cos(x[0] + u[8] - y[1]);
out[306] = -y[0]*sin(x[0] + u[8] - y[1]);
out[365] = 2.0*y[2]*u[10];
out[386] = 2.0*y[2]*u[11];
...
out[11] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[12] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[13] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[14] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[16] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[17] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[18] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[19] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[22] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[23] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[24] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[25] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[28] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[29] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[30] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
out[31] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[35] = -y[0]*cos(x[0] + u[8] - y[1]);
out[36] = -sin(x[0] + u[8] - y[1]);
out[37] = y[0]*cos(x[0] + u[8] - y[1]);
out[40] = y[0]*sin(x[0] + u[8] - y[1]);
out[42] = -cos(x[0] + u[8] - y[1]);
out[43] = -y[0]*sin(x[0] + u[8] - y[1]);
out[46] = y[0]*y[5]*cos(x[0] + u[8] - y[1]) - y[0]*y[6]*sin(x[0] + u[8] - y[1]);
out[47] = y[5]*sin(x[0] + u[8] - y[1]) + y[6]*cos(x[0] + u[8] - y[1]);
out[48] = -y[0]*y[5]*cos(x[0] + u[8] - y[1]) + y[0]*y[6]*sin(x[0] + u[8] - y[1]);
out[49] = y[0]*sin(x[0] + u[8] - y[1]);
out[50] = y[0]*cos(x[0] + u[8] - y[1]);
out[52] = -y[0]*y[5]*sin(x[0] + u[8] - y[1]) - y[0]*y[6]*cos(x[0] + u[8] - y[1]);
out[53] = y[5]*cos(x[0] + u[8] - y[1]) - y[6]*sin(x[0] + u[8] - y[1]);
out[54] = y[0]*y[5]*sin(x[0] + u[8] - y[1]) + y[0]*y[6]*cos(x[0] + u[8] - y[1]);
out[55] = y[0]*cos(x[0] + u[8] - y[1]);
out[56] = -y[0]*sin(x[0] + u[8] - y[1]);
out[62] = 2.0*y[2]*u[10];
out[64] = 2.0*y[2]*u[11];
...
out[10] = -3.1415926535897931*Dt*p[7];
out[19] = 3.1415926535897931*Dt*p[7];
out[22] = 0.5*Dt*p[11] + 1.0;
out[44] = 0.5*Dt*p[12] + 1.0;
out[66] = 0.5*Dt/p[13] + 1.0;
out[80] = -0.5*Dt/p[13];
out[88] = 0.5*Dt/p[14] + 1.0;
out[102] = -0.5*Dt/p[14];
out[110] = 0.5*Dt*p[17] + 1.0;
out[124] = 0.5*Dt;
out[139] = -p[6]/p[0];
out[161] = -p[6]/p[0];
out[242] = -p[9];
...
out[6] = -0.5*Dt/p[13];
out[7] = 0.5*Dt/p[14] + 1.0;
out[8] = -0.5*Dt/p[14];
out[9] = 0.5*Dt*p[17] + 1.0;
out[10] = 0.5*Dt;
out[15] = -p[6]/p[0];
out[20] = -p[6]/p[0];
out[38] = -p[9];
...
out[88] = -y[0]*cos(x[0] + u[8] - y[1]);
out[104] = y[0]*sin(x[0] + u[8] - y[1]);
out[120] = y[0]*y[5]*cos(x[0] + u[8] - y[1]) - y[0]*y[6]*sin(x[0] + u[8] - y[1]);
out[136] = -y[0]*y[5]*sin(x[0] + u[8] - y[1]) - y[0]*y[6]*cos(x[0] + u[8] - y[1]);
out[156] = y[2];
out[173] = y[2];
out[186] = pow(y[2], 2);
out[203] = pow(y[2], 2);
...
out[7] = -y[0]*cos(x[0] + u[8] - y[1]);
out[9] = y[0]*sin(x[0] + u[8] - y[1]);
out[10] = y[0]*y[5]*cos(x[0] + u[8] - y[1]) - y[0]*y[6]*sin(x[0] + u[8] - y[1]);
out[11] = -y[0]*y[5]*sin(x[0] + u[8] - y[1]) - y[0]*y[6]*cos(x[0] + u[8] - y[1]);
out[12] = y[2];
out[13] = y[2];
out[14] = pow(y[2], 2);
out[15] = pow(y[2], 2);
