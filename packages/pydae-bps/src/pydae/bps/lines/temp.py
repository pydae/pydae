...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 18 
        self.N_store = 100000 
        self.params_list = ['S_base', 'D_conductor_1_2', 'D_core_1_2', 'Emissivity_1_2', 'Absorptivity_1_2', 'Elevation_1_2', 'Mass_linear_1_2', 'Cp_1_2', 'K_dtr_1_2', 'g_1_2', 'b_1_2', 'bs_1_2', 'U_1_n', 'U_2_n', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [100000000.0, 0.0277, 0.00308, 0.8, 0.8, 0.0, 1.62, 900.0, 0.0, 48.86242680554943, -504.3040020304095, 161.56799999999998, 400000.0, 400000.0, 0.01, 0.01, 0.01] 
        self.inputs_ini_list = ['t_ambient_1_2', 'v_wind_1_2', 'angle_wind_1_2', 'irradiance_1_2', 'P_1', 'Q_1', 'P_2', 'Q_2', 'v_ref_1', 'theta_ref_1'] 
        self.inputs_ini_values_list  = [25.0, 1.0, 90.0, 1000.0, 0.0, 0.0, 5000000000.0, 0.0, 1.0, 0.0] 
        self.inputs_run_list = ['t_ambient_1_2', 'v_wind_1_2', 'angle_wind_1_2', 'irradiance_1_2', 'P_1', 'Q_1', 'P_2', 'Q_2', 'v_ref_1', 'theta_ref_1'] 
        self.inputs_run_values_list = [25.0, 1.0, 90.0, 1000.0, 0.0, 0.0, 5000000000.0, 0.0, 1.0, 0.0] 
        self.outputs_list = ['dens_1_2', 'reynolds_1_2', 'rayleigh_1_2', 'nu_1_2', 'p_c_1_2', 'p_s_1_2', 'R_ac_1_2', 'p_j_1_2', 't_conductor_1_2', 'V_1', 'V_2', 'p_line_1_2', 'q_line_1_2', 'p_line_2_1', 'q_line_2_1', 'I_line_1_2', 'I_line_2_1', 'V_dummy_1'] 
        self.x_list = ['t_conductor_1_2', 'V_dummy_1', 'xi_freq'] 
        self.y_run_list = ['dens_1_2', 'reynolds_1_2', 'rayleigh_1_2', 'nu_1_2', 'p_c_1_2', 'p_s_1_2', 'V_1', 'theta_1', 'V_2', 'theta_2', 'p_line_pu_1_2', 'q_line_pu_1_2', 'p_line_pu_2_1', 'q_line_pu_2_1', 'I_1_2', 'I_2_1', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['dens_1_2', 'reynolds_1_2', 'rayleigh_1_2', 'nu_1_2', 'p_c_1_2', 'p_s_1_2', 'V_1', 'theta_1', 'V_2', 'theta_2', 'p_line_pu_1_2', 'q_line_pu_1_2', 'p_line_pu_2_1', 'q_line_pu_2_1', 'I_1_2', 'I_2_1', 'omega_coi', 'p_agc'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 6, 17, 1, 2, 19, 0, 3, 0, 3, 4, 0, 3, 5, 4, 5, 6, 0, 6, 7, 8, 9, 10, 9, 10, 11, 12, 9, 10, 11, 12, 9, 10, 11, 12, 13, 9, 10, 11, 12, 14, 9, 10, 11, 12, 15, 9, 10, 11, 12, 16, 9, 13, 14, 17, 11, 15, 16, 18, 19, 2, 19, 20]
    sp_jac_ini_ja = [0, 3, 4, 6, 8, 11, 14, 17, 20, 21, 22, 23, 27, 31, 36, 41, 46, 51, 55, 59, 60, 63]
    sp_jac_ini_nia = 21
    sp_jac_ini_nja = 21
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 6, 17, 1, 2, 19, 0, 3, 0, 3, 4, 0, 3, 5, 4, 5, 6, 0, 6, 7, 8, 9, 10, 9, 10, 11, 12, 9, 10, 11, 12, 9, 10, 11, 12, 13, 9, 10, 11, 12, 14, 9, 10, 11, 12, 15, 9, 10, 11, 12, 16, 9, 13, 14, 17, 11, 15, 16, 18, 19, 2, 19, 20]
    sp_jac_run_ja = [0, 3, 4, 6, 8, 11, 14, 17, 20, 21, 22, 23, 27, 31, 36, 41, 46, 51, 55, 59, 60, 63]
    sp_jac_run_nia = 21
    sp_jac_run_nja = 21
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 6, 17, 1, 2, 19, 0, 3, 0, 3, 4, 0, 3, 5, 4, 5, 6, 0, 6, 7, 8, 9, 10, 9, 10, 11, 12, 9, 10, 11, 12, 9, 10, 11, 12, 13, 9, 10, 11, 12, 14, 9, 10, 11, 12, 15, 9, 10, 11, 12, 16, 9, 13, 14, 17, 11, 15, 16, 18, 19, 2, 19, 20]
    sp_jac_trap_ja = [0, 3, 4, 6, 8, 11, 14, 17, 20, 21, 22, 23, 27, 31, 36, 41, 46, 51, 55, 59, 60, 63]
    sp_jac_trap_nia = 21
    sp_jac_trap_nja = 21
