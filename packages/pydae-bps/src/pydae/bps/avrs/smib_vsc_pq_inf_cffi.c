...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_smib_vsc_pq_inf_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_smib_vsc_pq_inf_cffi(void) { return NULL; }
#  else
     initsmib_vsc_pq_inf_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_smib_vsc_pq_inf_cffi(void)
{
  return _cffi_init("smib_vsc_pq_inf_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initsmib_vsc_pq_inf_cffi(void)
{
  _cffi_init("smib_vsc_pq_inf_cffi", 0x2601, &_cffi_type_context);
}
#endif
