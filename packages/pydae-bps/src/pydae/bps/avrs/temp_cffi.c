...
out[0] = -p[21]*x[0] + p[10]*(x[1] - y[10]);
out[1] = (1.0/2.0)*(-p[19]*(x[1] - y[10]) - y[6]*(p[20]*y[6] + y[0]*sin(x[0] - y[1])) - y[7]*(p[20]*y[7] + y[0]*cos(x[0] - y[1])) + u[6])/p[12];
out[2] = (-x[2] - y[6]*(-p[17] + p[15]) + x[7])/p[13];
out[3] = (-x[3] + y[7]*(-p[18] + p[16]))/p[14];
out[4] = (y[2] - x[4])/p[25];
out[5] = (p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27];
out[6] = -y[2] + u[7];
out[7] = (p[23]*(u[9] - 1)*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) + u[9]*((p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   p[28]
)
: ((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   p[29]
)
: (
   p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])
))) - x[7])/p[25];
out[8] = x[8] - u[10];
out[9] = -p[32]*x[9] - y[10] + 1;

}
void g_ini_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[0] = -u[0]/p[0] + pow(y[0], 2)*p[1] + y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) - p[11]*y[8]/p[0];
out[1] = -u[1]/p[0] + pow(y[0], 2)*(-p[2] - 1.0/2.0*p[3]) + y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3])) - p[11]*y[9]/p[0];
...
out[4] = y[4] - u[10];
out[5] = y[5] - u[11];
out[6] = p[20]*y[7] + y[0]*cos(x[0] - y[1]) + p[17]*y[6] - x[2];
out[7] = p[20]*y[6] + y[0]*sin(x[0] - y[1]) - p[18]*y[7] - x[3];
out[8] = y[0]*y[6]*sin(x[0] - y[1]) + y[0]*y[7]*cos(x[0] - y[1]) - y[8];
out[9] = y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]) - y[9];
out[10] = -y[10] + (p[12]*p[11]*x[1] + 1000000000000000.0)/(p[12]*p[11] + 1000000000000000.0);
out[11] = p[31]*x[9] + p[30]*(1 - y[10]) - y[11];
...
out[1] = y[2];
out[2] = y[4];
out[3] = y[6]*(p[20]*y[6] + y[0]*sin(x[0] - y[1])) + y[7]*(p[20]*y[7] + y[0]*cos(x[0] - y[1]));
out[4] = x[7];
out[5] = u[6];
out[6] = u[7];
out[7] = x[8];
...
out[22] = 0.5*(-y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]))/p[12];
out[32] = 0.5*(-y[6]*sin(x[0] - y[1]) - y[7]*cos(x[0] - y[1]))/p[12];
out[33] = 0.5*(y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]))/p[12];
out[38] = 0.5*(-2.0*p[20]*y[6] - y[0]*sin(x[0] - y[1]))/p[12];
out[39] = 0.5*(-2.0*p[20]*y[7] - y[0]*cos(x[0] - y[1]))/p[12];
out[159] = (p[23]*(1.0 - p[26]/p[27])*(u[9] - 1.0) + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*(1.0 - p[26]/p[27])
)))/p[25];
out[160] = (p[23]*p[24]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*p[24]*p[26]/p[27]
)))/p[25];
out[166] = (-p[23]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   -p[23]*p[26]/p[27]
)))/p[25];
out[230] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[231] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[232] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[233] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[252] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[253] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[254] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[255] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[274] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[275] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[276] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*(p[1] + p[4]) + y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[277] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3])) + y[2]*y[4]*(-p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[278] = y[2]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[279] = y[2]*y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[296] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[297] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[298] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - p[5] - 0.5*p[3] - 0.5*p[6]) + y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[299] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + y[2]*y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[300] = y[2]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[301] = y[2]*y[4]*(p[5]*sin(y[3] - y[5]) + p[4]*cos(y[3] - y[5]));
out[352] = -y[0]*sin(x[0] - y[1]);
out[362] = cos(x[0] - y[1]);
out[363] = y[0]*sin(x[0] - y[1]);
out[374] = y[0]*cos(x[0] - y[1]);
out[384] = sin(x[0] - y[1]);
out[385] = -y[0]*cos(x[0] - y[1]);
out[396] = y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]);
out[406] = y[6]*sin(x[0] - y[1]) + y[7]*cos(x[0] - y[1]);
out[407] = -y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]);
out[412] = y[0]*sin(x[0] - y[1]);
out[413] = y[0]*cos(x[0] - y[1]);
out[418] = -y[0]*y[6]*sin(x[0] - y[1]) - y[0]*y[7]*cos(x[0] - y[1]);
out[428] = y[6]*cos(x[0] - y[1]) - y[7]*sin(x[0] - y[1]);
out[429] = y[0]*y[6]*sin(x[0] - y[1]) + y[0]*y[7]*cos(x[0] - y[1]);
out[434] = y[0]*cos(x[0] - y[1]);
out[435] = -y[0]*sin(x[0] - y[1]);
...
out[1] = p[10];
out[20] = -p[10];
out[23] = -0.5*p[19]/p[12];
out[42] = 0.5*p[19]/p[12];
out[46] = -1/p[13];
out[51] = 1.0/p[13];
out[60] = (p[17] - p[15])/p[13];
out[69] = -1/p[14];
out[83] = (-p[18] + p[16])/p[14];
out[92] = -1/p[25];
out[100] = 1.0/p[25];
out[115] = -1/p[27];
out[116] = p[24]/p[27];
...
out[390] = p[20];
out[391] = -p[18];
out[441] = p[12]*p[11]/(p[12]*p[11] + 1000000000000000.0);
out[471] = p[31];
out[482] = -p[30];
...
out[3] = 0.5*(-y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]))/p[12];
out[5] = 0.5*(-y[6]*sin(x[0] - y[1]) - y[7]*cos(x[0] - y[1]))/p[12];
out[6] = 0.5*(y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]))/p[12];
out[7] = 0.5*(-2.0*p[20]*y[6] - y[0]*sin(x[0] - y[1]))/p[12];
out[8] = 0.5*(-2.0*p[20]*y[7] - y[0]*cos(x[0] - y[1]))/p[12];
out[21] = (p[23]*(1.0 - p[26]/p[27])*(u[9] - 1.0) + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*(1.0 - p[26]/p[27])
)))/p[25];
out[22] = (p[23]*p[24]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*p[24]*p[26]/p[27]
)))/p[25];
out[24] = (-p[23]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   -p[23]*p[26]/p[27]
)))/p[25];
out[28] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[29] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[30] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[31] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[33] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[34] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[35] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[36] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[38] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[39] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[40] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*(p[1] + p[4]) + y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[41] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3])) + y[2]*y[4]*(-p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[42] = y[2]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[43] = y[2]*y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[44] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[45] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[46] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - p[5] - 0.5*p[3] - 0.5*p[6]) + y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[47] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + y[2]*y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[48] = y[2]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[49] = y[2]*y[4]*(p[5]*sin(y[3] - y[5]) + p[4]*cos(y[3] - y[5]));
out[52] = -y[0]*sin(x[0] - y[1]);
out[54] = cos(x[0] - y[1]);
out[55] = y[0]*sin(x[0] - y[1]);
out[58] = y[0]*cos(x[0] - y[1]);
out[60] = sin(x[0] - y[1]);
out[61] = -y[0]*cos(x[0] - y[1]);
out[64] = y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]);
out[65] = y[6]*sin(x[0] - y[1]) + y[7]*cos(x[0] - y[1]);
out[66] = -y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]);
out[67] = y[0]*sin(x[0] - y[1]);
out[68] = y[0]*cos(x[0] - y[1]);
out[70] = -y[0]*y[6]*sin(x[0] - y[1]) - y[0]*y[7]*cos(x[0] - y[1]);
out[71] = y[6]*cos(x[0] - y[1]) - y[7]*sin(x[0] - y[1]);
out[72] = y[0]*y[6]*sin(x[0] - y[1]) + y[0]*y[7]*cos(x[0] - y[1]);
out[73] = y[0]*cos(x[0] - y[1]);
out[74] = -y[0]*sin(x[0] - y[1]);
...
out[62] = p[20];
out[63] = -p[18];
out[76] = p[12]*p[11]/(p[12]*p[11] + 1000000000000000.0);
out[78] = p[31];
out[79] = -p[30];
...
out[22] = -0.25*Dt*(-y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]))/p[12];
out[32] = -0.25*Dt*(-y[6]*sin(x[0] - y[1]) - y[7]*cos(x[0] - y[1]))/p[12];
out[33] = -0.25*Dt*(y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]))/p[12];
out[38] = -0.25*Dt*(-2.0*p[20]*y[6] - y[0]*sin(x[0] - y[1]))/p[12];
out[39] = -0.25*Dt*(-2.0*p[20]*y[7] - y[0]*cos(x[0] - y[1]))/p[12];
out[159] = -0.5*Dt*(p[23]*(1.0 - p[26]/p[27])*(u[9] - 1.0) + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*(1.0 - p[26]/p[27])
)))/p[25];
out[160] = -0.5*Dt*(p[23]*p[24]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*p[24]*p[26]/p[27]
)))/p[25];
out[166] = -0.5*Dt*(-p[23]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   -p[23]*p[26]/p[27]
...
out[1] = -0.5*Dt*p[10];
out[20] = 0.5*Dt*p[10];
out[23] = 0.25*p[19]*Dt/p[12] + 1.0;
out[42] = -0.25*p[19]*Dt/p[12];
out[46] = 0.5*Dt/p[13] + 1.0;
out[51] = -0.5*Dt/p[13];
out[60] = -0.5*Dt*(p[17] - p[15])/p[13];
out[69] = 0.5*Dt/p[14] + 1.0;
out[83] = -0.5*Dt*(-p[18] + p[16])/p[14];
out[92] = 0.5*Dt/p[25] + 1.0;
out[100] = -0.5*Dt/p[25];
out[115] = 0.5*Dt/p[27] + 1.0;
out[116] = -0.5*Dt*p[24]/p[27];
out[122] = 0.5*Dt/p[27];
out[144] = 0.5*Dt;
out[161] = 0.5*Dt/p[25] + 1.0;
out[184] = 1.0 - 0.5*Dt;
out[207] = 0.5*Dt*p[32] + 1.0;
out[218] = 0.5*Dt;
out[238] = -p[11]/p[0];
out[261] = -p[11]/p[0];
out[368] = p[17];
...
out[3] = -0.25*Dt*(-y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]))/p[12];
out[5] = -0.25*Dt*(-y[6]*sin(x[0] - y[1]) - y[7]*cos(x[0] - y[1]))/p[12];
out[6] = -0.25*Dt*(y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]))/p[12];
out[7] = -0.25*Dt*(-2.0*p[20]*y[6] - y[0]*sin(x[0] - y[1]))/p[12];
out[8] = -0.25*Dt*(-2.0*p[20]*y[7] - y[0]*cos(x[0] - y[1]))/p[12];
out[22] = -0.5*Dt*(p[23]*(1.0 - p[26]/p[27])*(u[9] - 1.0) + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*(1.0 - p[26]/p[27])
)))/p[25];
out[23] = -0.5*Dt*(p[23]*p[24]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*p[24]*p[26]/p[27]
)))/p[25];
out[25] = -0.5*Dt*(-p[23]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   -p[23]*p[26]/p[27]
...
out[34] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[41] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*(p[1] + p[4]) + y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[42] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3])) + y[2]*y[4]*(-p[5]*cos(y[3] - y[5]) + p[4]*sin(y[3] - y[5]));
out[43] = y[2]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[44] = y[2]*y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[45] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[46] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[47] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - p[5] - 0.5*p[3] - 0.5*p[6]) + y[4]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[48] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + y[2]*y[4]*(-p[5]*sin(y[3] - y[5]) - p[4]*cos(y[3] - y[5]));
out[49] = y[2]*(p[5]*cos(y[3] - y[5]) - p[4]*sin(y[3] - y[5]));
out[50] = y[2]*y[4]*(p[5]*sin(y[3] - y[5]) + p[4]*cos(y[3] - y[5]));
out[53] = -y[0]*sin(x[0] - y[1]);
out[55] = cos(x[0] - y[1]);
out[56] = y[0]*sin(x[0] - y[1]);
out[59] = y[0]*cos(x[0] - y[1]);
out[61] = sin(x[0] - y[1]);
out[62] = -y[0]*cos(x[0] - y[1]);
out[65] = y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]);
out[66] = y[6]*sin(x[0] - y[1]) + y[7]*cos(x[0] - y[1]);
out[67] = -y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]);
out[68] = y[0]*sin(x[0] - y[1]);
out[69] = y[0]*cos(x[0] - y[1]);
out[71] = -y[0]*y[6]*sin(x[0] - y[1]) - y[0]*y[7]*cos(x[0] - y[1]);
out[72] = y[6]*cos(x[0] - y[1]) - y[7]*sin(x[0] - y[1]);
out[73] = y[0]*y[6]*sin(x[0] - y[1]) + y[0]*y[7]*cos(x[0] - y[1]);
out[74] = y[0]*cos(x[0] - y[1]);
...
out[9] = -0.25*p[19]*Dt/p[12];
out[10] = 0.5*Dt/p[13] + 1.0;
out[11] = -0.5*Dt/p[13];
out[12] = -0.5*Dt*(p[17] - p[15])/p[13];
out[13] = 0.5*Dt/p[14] + 1.0;
out[14] = -0.5*Dt*(-p[18] + p[16])/p[14];
out[15] = 0.5*Dt/p[25] + 1.0;
out[16] = -0.5*Dt/p[25];
out[17] = 0.5*Dt/p[27] + 1.0;
out[18] = -0.5*Dt*p[24]/p[27];
out[19] = 0.5*Dt/p[27];
out[21] = 0.5*Dt;
out[24] = 0.5*Dt/p[25] + 1.0;
out[26] = 1.0 - 0.5*Dt;
out[27] = 0.5*Dt*p[32] + 1.0;
out[28] = 0.5*Dt;
out[33] = -p[11]/p[0];
out[38] = -p[11]/p[0];
out[57] = p[17];
...
out[63] = p[20];
out[64] = -p[18];
out[77] = p[12]*p[11]/(p[12]*p[11] + 1000000000000000.0);
out[79] = p[31];
out[80] = -p[30];
...
out[91] = (p[23]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*p[26]/p[27]
)))/p[25];
out[92] = (p[23]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*p[26]/p[27]
)))/p[25];
out[93] = (p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) + ((p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   p[28]
)
: ((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   p[29]
...
out[30] = y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]);
...
out[36] = y[6]*sin(x[0] - y[1]) + y[7]*cos(x[0] - y[1]);
out[37] = -y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]);
out[42] = 2.0*p[20]*y[6] + y[0]*sin(x[0] - y[1]);
out[43] = 2.0*p[20]*y[7] + y[0]*cos(x[0] - y[1]);
...
out[4] = (p[23]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*p[26]/p[27]
)))/p[25];
out[5] = (p[23]*p[26]*(u[9] - 1.0)/p[27] + u[9]*((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) || p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   0
)
: (
   p[23]*p[26]/p[27]
)))/p[25];
out[6] = (p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27]) + ((p[28] < p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   p[28]
)
: ((p[29] > p[23]*(x[5] + p[26]*(p[24]*x[6] - y[2] + u[8] + u[7] - x[5])/p[27])) ? (
   p[29]
...
out[0] = y[0]*y[6]*cos(x[0] - y[1]) - y[0]*y[7]*sin(x[0] - y[1]);
...
out[3] = y[6]*sin(x[0] - y[1]) + y[7]*cos(x[0] - y[1]);
out[4] = -y[0]*y[6]*cos(x[0] - y[1]) + y[0]*y[7]*sin(x[0] - y[1]);
out[5] = 2.0*p[20]*y[6] + y[0]*sin(x[0] - y[1]);
out[6] = 2.0*p[20]*y[7] + y[0]*cos(x[0] - y[1]);
