...
if dae_file_mode == 'local':
    import smib_vsc_pq_inf_cffi as jacs
if dae_file_mode == 'enviroment':
    import envus.no_enviroment.smib_vsc_pq_inf_cffi as jacs
if dae_file_mode == 'colab':
    import smib_vsc_pq_inf_cffi as jacs
if dae_file_mode == 'testing':
    from pydae.temp import smib_vsc_pq_inf_cffi as jacs
...
class model: 
    ...
    def __init__(self,matrices_folder='./build'): 
        ...
        self.params_values_list  = [100000000.0, 20000.0, 10000000.0, 0.0, 0.0, 1e-06] 
        self.inputs_ini_list = ['P_1', 'Q_1', 'p_in_1', 'Dp_r_1', 'Dq_r_1', 'v_ref_1_0', 'theta_ref_1_0'] 
        self.inputs_ini_values_list  = [0.0, 0.0, 0.5, 0.0, 0.0, 1.0, 0.0] 
        self.inputs_run_list = ['P_1', 'Q_1', 'p_in_1', 'Dp_r_1', 'Dq_r_1', 'v_ref_1_0', 'theta_ref_1_0'] 
        self.inputs_run_values_list = [0.0, 0.0, 0.5, 0.0, 0.0, 1.0, 0.0] 
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, f'./smib_vsc_pq_inf_sp_jac_ini_num.npz'))
            self.sp_jac_ini = sspa.load_npz(fobj)
        else:
            self.sp_jac_ini = sspa.load_npz(f'{self.matrices_folder}/smib_vsc_pq_inf_sp_jac_ini_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './smib_vsc_pq_inf_sp_jac_run_num.npz'))
            self.sp_jac_run = sspa.load_npz(fobj)
        else:
            self.sp_jac_run = sspa.load_npz(f'{self.matrices_folder}/smib_vsc_pq_inf_sp_jac_run_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './smib_vsc_pq_inf_sp_jac_trap_num.npz'))
            self.sp_jac_trap = sspa.load_npz(fobj)
        else:
            self.sp_jac_trap = sspa.load_npz(f'{self.matrices_folder}/smib_vsc_pq_inf_sp_jac_trap_num.npz')
        ...
        self.sp_Fu_run = sspa.load_npz(f'{self.matrices_folder}/smib_vsc_pq_inf_Fu_run_num.npz')
        self.sp_Gu_run = sspa.load_npz(f'{self.matrices_folder}/smib_vsc_pq_inf_Gu_run_num.npz')
        self.sp_Hx_run = sspa.load_npz(f'{self.matrices_folder}/smib_vsc_pq_inf_Hx_run_num.npz')
        self.sp_Hy_run = sspa.load_npz(f'{self.matrices_folder}/smib_vsc_pq_inf_Hy_run_num.npz')
        self.sp_Hu_run = sspa.load_npz(f'{self.matrices_folder}/smib_vsc_pq_inf_Hu_run_num.npz')        
