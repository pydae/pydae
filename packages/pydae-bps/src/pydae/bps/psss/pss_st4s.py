...
def pss_kundur(dae,syn_data,name,bus_name,backend=None):
    '''
    PSS as IEEE PSS2
    ...
    # states
    x_wo1 = backend.symbols(f"x_wo1 _{name}", real=True)
    x_wo2 = backend.symbols(f"x_wo2 _{name}", real=True)
    x_wo3 = backend.symbols(f"x_wo3 _{name}", real=True)
    x_lpf7= backend.symbols(f"x_lpf7_{name}", real=True)
    x_9_1 = backend.symbols(f"x_9_1 _{name}", real=True)
    x_9_2 = backend.symbols(f"x_9_2 _{name}", real=True)
    x_9_3 = backend.symbols(f"x_9_3 _{name}", real=True)
    x_9_4 = backend.symbols(f"x_9_4 _{name}", real=True)
    x_9_5 = backend.symbols(f"x_9_5 _{name}", real=True)
    x_ll1 = backend.symbols(f"x_ll1 _{name}", real=True)
    x_ll3 = backend.symbols(f"x_ll3 _{name}", real=True)
