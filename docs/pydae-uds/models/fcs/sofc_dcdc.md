...
The `sofc_dcdc` model is instantiated by including an entry in the relevant
...
`packages/pydae-uds/src/pydae/uds/fcs/sofc_dcdc.py` and re-run `docs/pydae-uds/_scripts/generate_model_pages.py`
...
- Module: `pydae.uds.fcs.sofc_dcdc`
- File: [`packages/pydae-uds/src/pydae/uds/fcs/sofc_dcdc.py`](https://github.com/pydae/pydae/tree/master/packages/pydae-uds/src/pydae/uds/fcs/sofc_dcdc.py)
