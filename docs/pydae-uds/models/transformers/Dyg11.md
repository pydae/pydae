...
The `Dyg11` model is instantiated by including an entry in the relevant
...
`packages/pydae-uds/src/pydae/uds/transformers/Dyg11.py` and re-run `docs/pydae-uds/_scripts/generate_model_pages.py`
...
- Module: `pydae.uds.transformers.Dyg11`
- File: [`packages/pydae-uds/src/pydae/uds/transformers/Dyg11.py`](https://github.com/pydae/pydae/tree/master/packages/pydae-uds/src/pydae/uds/transformers/Dyg11.py)
