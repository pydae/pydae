...
The `vdc_src` model is instantiated by including an entry in the relevant
...
`packages/pydae-uds/src/pydae/uds/sources/vdc_src.py` and re-run `docs/pydae-uds/_scripts/generate_model_pages.py`
...
- Module: `pydae.uds.sources.vdc_src`
- File: [`packages/pydae-uds/src/pydae/uds/sources/vdc_src.py`](https://github.com/pydae/pydae/tree/master/packages/pydae-uds/src/pydae/uds/sources/vdc_src.py)
