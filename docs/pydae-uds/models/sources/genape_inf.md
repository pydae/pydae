...
`packages/pydae-uds/src/pydae/uds/sources/genape_inf.py` and re-run `docs/pydae-uds/_scripts/generate_model_pages.py`
...
- Module: `pydae.uds.sources.genape_inf`
- File: [`packages/pydae-uds/src/pydae/uds/sources/genape_inf.py`](https://github.com/pydae/pydae/tree/master/packages/pydae-uds/src/pydae/uds/sources/genape_inf.py)
