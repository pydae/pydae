...
The `ac3ph4wgfpidq` model is instantiated by including an entry in the relevant
...
`packages/pydae-uds/src/pydae/uds/vscs/ac3ph4wgfpidq.py` and re-run `docs/pydae-uds/_scripts/generate_model_pages.py`
...
- Module: `pydae.uds.vscs.ac3ph4wgfpidq`
- File: [`packages/pydae-uds/src/pydae/uds/vscs/ac3ph4wgfpidq.py`](https://github.com/pydae/pydae/tree/master/packages/pydae-uds/src/pydae/uds/vscs/ac3ph4wgfpidq.py)
