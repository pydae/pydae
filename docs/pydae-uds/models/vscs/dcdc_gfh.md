...
The `dcdc_gfh` model is instantiated by including an entry in the relevant
...
`packages/pydae-uds/src/pydae/uds/vscs/dcdc_gfh.py` and re-run `docs/pydae-uds/_scripts/generate_model_pages.py`
...
- Module: `pydae.uds.vscs.dcdc_gfh`
- File: [`packages/pydae-uds/src/pydae/uds/vscs/dcdc_gfh.py`](https://github.com/pydae/pydae/tree/master/packages/pydae-uds/src/pydae/uds/vscs/dcdc_gfh.py)
