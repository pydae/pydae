...
The `ac3ph4wgf` model is instantiated by including an entry in the relevant
...
`packages/pydae-uds/src/pydae/uds/vscs/ac3ph4wgf.py` and re-run `docs/pydae-uds/_scripts/generate_model_pages.py`
...
- Module: `pydae.uds.vscs.ac3ph4wgf`
- File: [`packages/pydae-uds/src/pydae/uds/vscs/ac3ph4wgf.py`](https://github.com/pydae/pydae/tree/master/packages/pydae-uds/src/pydae/uds/vscs/ac3ph4wgf.py)
