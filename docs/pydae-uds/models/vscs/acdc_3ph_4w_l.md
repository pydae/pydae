...
The `acdc_3ph_4w_l` model is instantiated by including an entry in the relevant
...
`packages/pydae-uds/src/pydae/uds/vscs/acdc_3ph_4w_l.py` and re-run `docs/pydae-uds/_scripts/generate_model_pages.py`
...
- Module: `pydae.uds.vscs.acdc_3ph_4w_l`
- File: [`packages/pydae-uds/src/pydae/uds/vscs/acdc_3ph_4w_l.py`](https://github.com/pydae/pydae/tree/master/packages/pydae-uds/src/pydae/uds/vscs/acdc_3ph_4w_l.py)
