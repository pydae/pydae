...
`packages/pydae-uds/src/pydae/uds/ess/bess_dcdc.py` and re-run `docs/pydae-uds/_scripts/generate_model_pages.py`
...
- Module: `pydae.uds.ess.bess_dcdc`
- File: [`packages/pydae-uds/src/pydae/uds/ess/bess_dcdc.py`](https://github.com/pydae/pydae/tree/master/packages/pydae-uds/src/pydae/uds/ess/bess_dcdc.py)
