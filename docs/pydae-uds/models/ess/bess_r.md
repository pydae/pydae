...
`packages/pydae-uds/src/pydae/uds/ess/bess_r.py` and re-run `docs/pydae-uds/_scripts/generate_model_pages.py`
...
- Module: `pydae.uds.ess.bess_r`
- File: [`packages/pydae-uds/src/pydae/uds/ess/bess_r.py`](https://github.com/pydae/pydae/tree/master/packages/pydae-uds/src/pydae/uds/ess/bess_r.py)
