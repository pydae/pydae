...
The `ntsieeeg1` model is instantiated by including an entry in the relevant
...
`packages/pydae-bps/src/pydae/bps/govs/ntsieeeg1.py` and re-run `docs/pydae-bps/_scripts/generate_model_pages.py`
