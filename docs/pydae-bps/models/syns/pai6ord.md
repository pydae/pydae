...
The `pai6ord` model is instantiated by including an entry in the relevant
...
`packages/pydae-bps/src/pydae/bps/syns/pai6ord.py` and re-run `docs/pydae-bps/_scripts/generate_model_pages.py`
