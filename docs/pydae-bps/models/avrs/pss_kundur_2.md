...
`packages/pydae-bps/src/pydae/bps/avrs/pss_kundur_2.py` and re-run `docs/pydae-bps/_scripts/generate_model_pages.py`
...
- Module: `pydae.bps.avrs.pss_kundur_2`
- File: [`packages/pydae-bps/src/pydae/bps/avrs/pss_kundur_2.py`](https://github.com/pydae/pydae/tree/main/packages/pydae-bps/src/pydae/bps/avrs/pss_kundur_2.py)
