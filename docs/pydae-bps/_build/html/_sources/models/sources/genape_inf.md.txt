...
`packages/pydae-bps/src/pydae/bps/sources/genape_inf.py` and re-run `docs/pydae-bps/_scripts/generate_model_pages.py`
...
- Module: `pydae.bps.sources.genape_inf`
- File: [`packages/pydae-bps/src/pydae/bps/sources/genape_inf.py`](https://github.com/pydae/pydae/tree/main/packages/pydae-bps/src/pydae/bps/sources/genape_inf.py)
