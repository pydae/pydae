...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_pend1_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_pend1_cffi(void) { return NULL; }
#  else
     initpend1_cffi(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_pend1_cffi(void)
{
  return _cffi_init("pend1_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initpend1_cffi(void)
{
  _cffi_init("pend1_cffi", 0x2601, &_cffi_type_context);
}
#endif
