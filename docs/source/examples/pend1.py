...
class pend1_class: 
    ...
    def __init__(self): 
        ...
        self.sp_jac_ini = sspa.load_npz('pend1_sp_jac_ini_num.npz')
        ...
        self.sp_jac_run = sspa.load_npz('pend1_sp_jac_run_num.npz')
        ...
        self.sp_jac_trap = sspa.load_npz('pend1_sp_jac_trap_num.npz')
