...
def ini(struct,mode):
    ...
    v_m_W1lv = struct[0].y_ini[72,0]
    v_m_W1mv = struct[0].y_ini[73,0]
    i_reac_ref_W1lv = struct[0].y_ini[74,0]
    q_ref_W1lv = struct[0].y_ini[75,0]
    i_W2lv_a_r = struct[0].y_ini[76,0]
    i_W2lv_a_i = struct[0].y_ini[77,0]
    i_W2lv_b_r = struct[0].y_ini[78,0]
    i_W2lv_b_i = struct[0].y_ini[79,0]
    i_W2lv_c_r = struct[0].y_ini[80,0]
    i_W2lv_c_i = struct[0].y_ini[81,0]
    v_m_W2lv = struct[0].y_ini[82,0]
    v_m_W2mv = struct[0].y_ini[83,0]
    i_reac_ref_W2lv = struct[0].y_ini[84,0]
    q_ref_W2lv = struct[0].y_ini[85,0]
    i_W3lv_a_r = struct[0].y_ini[86,0]
    i_W3lv_a_i = struct[0].y_ini[87,0]
    i_W3lv_b_r = struct[0].y_ini[88,0]
    i_W3lv_b_i = struct[0].y_ini[89,0]
    i_W3lv_c_r = struct[0].y_ini[90,0]
    i_W3lv_c_i = struct[0].y_ini[91,0]
    v_m_W3lv = struct[0].y_ini[92,0]
    v_m_W3mv = struct[0].y_ini[93,0]
    i_reac_ref_W3lv = struct[0].y_ini[94,0]
    q_ref_W3lv = struct[0].y_ini[95,0]
    i_STlv_a_r = struct[0].y_ini[96,0]
    i_STlv_a_i = struct[0].y_ini[97,0]
    i_STlv_b_r = struct[0].y_ini[98,0]
    i_STlv_b_i = struct[0].y_ini[99,0]
    i_STlv_c_r = struct[0].y_ini[100,0]
    i_STlv_c_i = struct[0].y_ini[101,0]
    v_m_STlv = struct[0].y_ini[102,0]
    v_m_STmv = struct[0].y_ini[103,0]
    i_reac_ref_STlv = struct[0].y_ini[104,0]
    q_ref_STlv = struct[0].y_ini[105,0]
    ...
    if mode == 3:
        ...
        struct[0].g[72,0] = -v_m_W1lv + (v_W1lv_a_i**2 + v_W1lv_a_r**2)**0.5/V_base_W1lv
        struct[0].g[73,0] = -v_m_W1mv + (v_W1mv_a_i**2 + v_W1mv_a_r**2)**0.5/V_base_W1mv
        struct[0].g[74,0] = Dq_r_W1lv + K_p_v_W1lv*(Dv_r_W1lv - u_ctrl_v_W1lv*v_m_W1mv + v_loc_ref_W1lv - v_m_W1lv*(1.0 - u_ctrl_v_W1lv)) - i_reac_ref_W1lv
        struct[0].g[75,0] = S_base_W1lv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(-I_max_W1lv, I_max_W1lv < -i_reac_ref_W1lv), (I_max_W1lv, I_max_W1lv < i_reac_ref_W1lv), (i_reac_ref_W1lv, True)])) - q_ref_W1lv
        struct[0].g[76,0] = i_W2lv_a_i*v_W2lv_a_i + i_W2lv_a_r*v_W2lv_a_r - p_W2lv_a
        struct[0].g[77,0] = i_W2lv_b_i*v_W2lv_b_i + i_W2lv_b_r*v_W2lv_b_r - p_W2lv_b
        struct[0].g[78,0] = i_W2lv_c_i*v_W2lv_c_i + i_W2lv_c_r*v_W2lv_c_r - p_W2lv_c
        struct[0].g[79,0] = -i_W2lv_a_i*v_W2lv_a_r + i_W2lv_a_r*v_W2lv_a_i - q_W2lv_a
        struct[0].g[80,0] = -i_W2lv_b_i*v_W2lv_b_r + i_W2lv_b_r*v_W2lv_b_i - q_W2lv_b
        struct[0].g[81,0] = -i_W2lv_c_i*v_W2lv_c_r + i_W2lv_c_r*v_W2lv_c_i - q_W2lv_c
        struct[0].g[82,0] = -v_m_W2lv + (v_W2lv_a_i**2 + v_W2lv_a_r**2)**0.5/V_base_W2lv
        struct[0].g[83,0] = -v_m_W2mv + (v_W2mv_a_i**2 + v_W2mv_a_r**2)**0.5/V_base_W2mv
        struct[0].g[84,0] = Dq_r_W2lv + K_p_v_W2lv*(Dv_r_W2lv - u_ctrl_v_W2lv*v_m_W2mv + v_loc_ref_W2lv - v_m_W2lv*(1.0 - u_ctrl_v_W2lv)) - i_reac_ref_W2lv
        struct[0].g[85,0] = S_base_W2lv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(-I_max_W2lv, I_max_W2lv < -i_reac_ref_W2lv), (I_max_W2lv, I_max_W2lv < i_reac_ref_W2lv), (i_reac_ref_W2lv, True)])) - q_ref_W2lv
        struct[0].g[86,0] = i_W3lv_a_i*v_W3lv_a_i + i_W3lv_a_r*v_W3lv_a_r - p_W3lv_a
        struct[0].g[87,0] = i_W3lv_b_i*v_W3lv_b_i + i_W3lv_b_r*v_W3lv_b_r - p_W3lv_b
        struct[0].g[88,0] = i_W3lv_c_i*v_W3lv_c_i + i_W3lv_c_r*v_W3lv_c_r - p_W3lv_c
        struct[0].g[89,0] = -i_W3lv_a_i*v_W3lv_a_r + i_W3lv_a_r*v_W3lv_a_i - q_W3lv_a
        struct[0].g[90,0] = -i_W3lv_b_i*v_W3lv_b_r + i_W3lv_b_r*v_W3lv_b_i - q_W3lv_b
        struct[0].g[91,0] = -i_W3lv_c_i*v_W3lv_c_r + i_W3lv_c_r*v_W3lv_c_i - q_W3lv_c
        struct[0].g[92,0] = -v_m_W3lv + (v_W3lv_a_i**2 + v_W3lv_a_r**2)**0.5/V_base_W3lv
        struct[0].g[93,0] = -v_m_W3mv + (v_W3mv_a_i**2 + v_W3mv_a_r**2)**0.5/V_base_W3mv
        struct[0].g[94,0] = Dq_r_W3lv + K_p_v_W3lv*(Dv_r_W3lv - u_ctrl_v_W3lv*v_m_W3mv + v_loc_ref_W3lv - v_m_W3lv*(1.0 - u_ctrl_v_W3lv)) - i_reac_ref_W3lv
        struct[0].g[95,0] = S_base_W3lv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(-I_max_W3lv, I_max_W3lv < -i_reac_ref_W3lv), (I_max_W3lv, I_max_W3lv < i_reac_ref_W3lv), (i_reac_ref_W3lv, True)])) - q_ref_W3lv
        struct[0].g[96,0] = i_STlv_a_i*v_STlv_a_i + i_STlv_a_r*v_STlv_a_r - p_STlv_a
        struct[0].g[97,0] = i_STlv_b_i*v_STlv_b_i + i_STlv_b_r*v_STlv_b_r - p_STlv_b
        struct[0].g[98,0] = i_STlv_c_i*v_STlv_c_i + i_STlv_c_r*v_STlv_c_r - p_STlv_c
        struct[0].g[99,0] = -i_STlv_a_i*v_STlv_a_r + i_STlv_a_r*v_STlv_a_i - q_STlv_a
        struct[0].g[100,0] = -i_STlv_b_i*v_STlv_b_r + i_STlv_b_r*v_STlv_b_i - q_STlv_b
        struct[0].g[101,0] = -i_STlv_c_i*v_STlv_c_r + i_STlv_c_r*v_STlv_c_i - q_STlv_c
        struct[0].g[102,0] = -v_m_STlv + (v_STlv_a_i**2 + v_STlv_a_r**2)**0.5/V_base_STlv
        struct[0].g[103,0] = -v_m_STmv + (v_STmv_a_i**2 + v_STmv_a_r**2)**0.5/V_base_STmv
        struct[0].g[104,0] = Dq_r_STlv + K_p_v_STlv*(Dv_r_STlv - u_ctrl_v_STlv*v_m_STmv + v_loc_ref_STlv - v_m_STlv*(1.0 - u_ctrl_v_STlv)) - i_reac_ref_STlv
        struct[0].g[105,0] = S_base_STlv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(-I_max_STlv, I_max_STlv < -i_reac_ref_STlv), (I_max_STlv, I_max_STlv < i_reac_ref_STlv), (i_reac_ref_STlv, True)])) - q_ref_STlv
    ...
    if mode == 11:
        ...
        struct[0].Fy_ini[3,75] = 1/(3*T_pq_W1lv) 
        struct[0].Fy_ini[4,75] = 1/(3*T_pq_W1lv) 
        struct[0].Fy_ini[5,75] = 1/(3*T_pq_W1lv) 
        struct[0].Fy_ini[9,85] = 1/(3*T_pq_W2lv) 
        struct[0].Fy_ini[10,85] = 1/(3*T_pq_W2lv) 
        struct[0].Fy_ini[11,85] = 1/(3*T_pq_W2lv) 
        struct[0].Fy_ini[15,95] = 1/(3*T_pq_W3lv) 
        struct[0].Fy_ini[16,95] = 1/(3*T_pq_W3lv) 
        struct[0].Fy_ini[17,95] = 1/(3*T_pq_W3lv) 
        struct[0].Fy_ini[21,105] = 1/(3*T_pq_STlv) 
        struct[0].Fy_ini[22,105] = 1/(3*T_pq_STlv) 
        struct[0].Fy_ini[23,105] = 1/(3*T_pq_STlv) 
        ...
        struct[0].Gx_ini[76,6] = -1
        struct[0].Gx_ini[77,7] = -1
        struct[0].Gx_ini[78,8] = -1
        struct[0].Gx_ini[79,9] = -1
        struct[0].Gx_ini[80,10] = -1
        struct[0].Gx_ini[81,11] = -1
        struct[0].Gx_ini[86,12] = -1
        struct[0].Gx_ini[87,13] = -1
        struct[0].Gx_ini[88,14] = -1
        struct[0].Gx_ini[89,15] = -1
        struct[0].Gx_ini[90,16] = -1
        struct[0].Gx_ini[91,17] = -1
        struct[0].Gx_ini[96,18] = -1
        struct[0].Gx_ini[97,19] = -1
        struct[0].Gx_ini[98,20] = -1
        struct[0].Gx_ini[99,21] = -1
        struct[0].Gx_ini[100,22] = -1
        struct[0].Gx_ini[101,23] = -1
        ...
        struct[0].Gy_ini[72,0] = 1.0*v_W1lv_a_r*(v_W1lv_a_i**2 + v_W1lv_a_r**2)**(-0.5)/V_base_W1lv
        struct[0].Gy_ini[72,1] = 1.0*v_W1lv_a_i*(v_W1lv_a_i**2 + v_W1lv_a_r**2)**(-0.5)/V_base_W1lv
        struct[0].Gy_ini[73,36] = 1.0*v_W1mv_a_r*(v_W1mv_a_i**2 + v_W1mv_a_r**2)**(-0.5)/V_base_W1mv
        struct[0].Gy_ini[73,37] = 1.0*v_W1mv_a_i*(v_W1mv_a_i**2 + v_W1mv_a_r**2)**(-0.5)/V_base_W1mv
        struct[0].Gy_ini[74,72] = K_p_v_W1lv*(u_ctrl_v_W1lv - 1.0)
        struct[0].Gy_ini[74,73] = -K_p_v_W1lv*u_ctrl_v_W1lv
        struct[0].Gy_ini[75,58] = 1.0*S_base_W1lv*v_STmv_c_r*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W1lv, I_max_W1lv < -i_reac_ref_W1lv), (I_max_W1lv, I_max_W1lv < i_reac_ref_W1lv), (i_reac_ref_W1lv, True)]))
        struct[0].Gy_ini[75,59] = 1.0*S_base_W1lv*v_STmv_c_i*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W1lv, I_max_W1lv < -i_reac_ref_W1lv), (I_max_W1lv, I_max_W1lv < i_reac_ref_W1lv), (i_reac_ref_W1lv, True)]))
        struct[0].Gy_ini[75,74] = S_base_W1lv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(0, (I_max_W1lv < i_reac_ref_W1lv) | (I_max_W1lv < -i_reac_ref_W1lv)), (1, True)]))
        struct[0].Gy_ini[76,6] = i_W2lv_a_r
        struct[0].Gy_ini[76,7] = i_W2lv_a_i
        struct[0].Gy_ini[76,76] = v_W2lv_a_r
        struct[0].Gy_ini[76,77] = v_W2lv_a_i
        struct[0].Gy_ini[77,8] = i_W2lv_b_r
        struct[0].Gy_ini[77,9] = i_W2lv_b_i
        struct[0].Gy_ini[77,78] = v_W2lv_b_r
        struct[0].Gy_ini[77,79] = v_W2lv_b_i
        struct[0].Gy_ini[78,10] = i_W2lv_c_r
        struct[0].Gy_ini[78,11] = i_W2lv_c_i
        struct[0].Gy_ini[78,80] = v_W2lv_c_r
        struct[0].Gy_ini[78,81] = v_W2lv_c_i
        struct[0].Gy_ini[79,6] = -i_W2lv_a_i
        struct[0].Gy_ini[79,7] = i_W2lv_a_r
        struct[0].Gy_ini[79,76] = v_W2lv_a_i
        struct[0].Gy_ini[79,77] = -v_W2lv_a_r
        struct[0].Gy_ini[80,8] = -i_W2lv_b_i
        struct[0].Gy_ini[80,9] = i_W2lv_b_r
        struct[0].Gy_ini[80,78] = v_W2lv_b_i
        struct[0].Gy_ini[80,79] = -v_W2lv_b_r
        struct[0].Gy_ini[81,10] = -i_W2lv_c_i
        struct[0].Gy_ini[81,11] = i_W2lv_c_r
        struct[0].Gy_ini[81,80] = v_W2lv_c_i
        struct[0].Gy_ini[81,81] = -v_W2lv_c_r
        struct[0].Gy_ini[82,6] = 1.0*v_W2lv_a_r*(v_W2lv_a_i**2 + v_W2lv_a_r**2)**(-0.5)/V_base_W2lv
        struct[0].Gy_ini[82,7] = 1.0*v_W2lv_a_i*(v_W2lv_a_i**2 + v_W2lv_a_r**2)**(-0.5)/V_base_W2lv
        struct[0].Gy_ini[83,42] = 1.0*v_W2mv_a_r*(v_W2mv_a_i**2 + v_W2mv_a_r**2)**(-0.5)/V_base_W2mv
        struct[0].Gy_ini[83,43] = 1.0*v_W2mv_a_i*(v_W2mv_a_i**2 + v_W2mv_a_r**2)**(-0.5)/V_base_W2mv
        struct[0].Gy_ini[84,82] = K_p_v_W2lv*(u_ctrl_v_W2lv - 1.0)
        struct[0].Gy_ini[84,83] = -K_p_v_W2lv*u_ctrl_v_W2lv
        struct[0].Gy_ini[85,58] = 1.0*S_base_W2lv*v_STmv_c_r*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W2lv, I_max_W2lv < -i_reac_ref_W2lv), (I_max_W2lv, I_max_W2lv < i_reac_ref_W2lv), (i_reac_ref_W2lv, True)]))
        struct[0].Gy_ini[85,59] = 1.0*S_base_W2lv*v_STmv_c_i*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W2lv, I_max_W2lv < -i_reac_ref_W2lv), (I_max_W2lv, I_max_W2lv < i_reac_ref_W2lv), (i_reac_ref_W2lv, True)]))
        struct[0].Gy_ini[85,84] = S_base_W2lv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(0, (I_max_W2lv < i_reac_ref_W2lv) | (I_max_W2lv < -i_reac_ref_W2lv)), (1, True)]))
        struct[0].Gy_ini[86,12] = i_W3lv_a_r
        struct[0].Gy_ini[86,13] = i_W3lv_a_i
        struct[0].Gy_ini[86,86] = v_W3lv_a_r
        struct[0].Gy_ini[86,87] = v_W3lv_a_i
        struct[0].Gy_ini[87,14] = i_W3lv_b_r
        struct[0].Gy_ini[87,15] = i_W3lv_b_i
        struct[0].Gy_ini[87,88] = v_W3lv_b_r
        struct[0].Gy_ini[87,89] = v_W3lv_b_i
        struct[0].Gy_ini[88,16] = i_W3lv_c_r
        struct[0].Gy_ini[88,17] = i_W3lv_c_i
        struct[0].Gy_ini[88,90] = v_W3lv_c_r
        struct[0].Gy_ini[88,91] = v_W3lv_c_i
        struct[0].Gy_ini[89,12] = -i_W3lv_a_i
        struct[0].Gy_ini[89,13] = i_W3lv_a_r
        struct[0].Gy_ini[89,86] = v_W3lv_a_i
        struct[0].Gy_ini[89,87] = -v_W3lv_a_r
        struct[0].Gy_ini[90,14] = -i_W3lv_b_i
        struct[0].Gy_ini[90,15] = i_W3lv_b_r
        struct[0].Gy_ini[90,88] = v_W3lv_b_i
        struct[0].Gy_ini[90,89] = -v_W3lv_b_r
        struct[0].Gy_ini[91,16] = -i_W3lv_c_i
        struct[0].Gy_ini[91,17] = i_W3lv_c_r
        struct[0].Gy_ini[91,90] = v_W3lv_c_i
        struct[0].Gy_ini[91,91] = -v_W3lv_c_r
        struct[0].Gy_ini[92,12] = 1.0*v_W3lv_a_r*(v_W3lv_a_i**2 + v_W3lv_a_r**2)**(-0.5)/V_base_W3lv
        struct[0].Gy_ini[92,13] = 1.0*v_W3lv_a_i*(v_W3lv_a_i**2 + v_W3lv_a_r**2)**(-0.5)/V_base_W3lv
        struct[0].Gy_ini[93,48] = 1.0*v_W3mv_a_r*(v_W3mv_a_i**2 + v_W3mv_a_r**2)**(-0.5)/V_base_W3mv
        struct[0].Gy_ini[93,49] = 1.0*v_W3mv_a_i*(v_W3mv_a_i**2 + v_W3mv_a_r**2)**(-0.5)/V_base_W3mv
        struct[0].Gy_ini[94,92] = K_p_v_W3lv*(u_ctrl_v_W3lv - 1.0)
        struct[0].Gy_ini[94,93] = -K_p_v_W3lv*u_ctrl_v_W3lv
        struct[0].Gy_ini[95,58] = 1.0*S_base_W3lv*v_STmv_c_r*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W3lv, I_max_W3lv < -i_reac_ref_W3lv), (I_max_W3lv, I_max_W3lv < i_reac_ref_W3lv), (i_reac_ref_W3lv, True)]))
        struct[0].Gy_ini[95,59] = 1.0*S_base_W3lv*v_STmv_c_i*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W3lv, I_max_W3lv < -i_reac_ref_W3lv), (I_max_W3lv, I_max_W3lv < i_reac_ref_W3lv), (i_reac_ref_W3lv, True)]))
        struct[0].Gy_ini[95,94] = S_base_W3lv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(0, (I_max_W3lv < i_reac_ref_W3lv) | (I_max_W3lv < -i_reac_ref_W3lv)), (1, True)]))
        struct[0].Gy_ini[96,18] = i_STlv_a_r
        struct[0].Gy_ini[96,19] = i_STlv_a_i
        struct[0].Gy_ini[96,96] = v_STlv_a_r
        struct[0].Gy_ini[96,97] = v_STlv_a_i
        struct[0].Gy_ini[97,20] = i_STlv_b_r
        struct[0].Gy_ini[97,21] = i_STlv_b_i
        struct[0].Gy_ini[97,98] = v_STlv_b_r
        struct[0].Gy_ini[97,99] = v_STlv_b_i
        struct[0].Gy_ini[98,22] = i_STlv_c_r
        struct[0].Gy_ini[98,23] = i_STlv_c_i
        struct[0].Gy_ini[98,100] = v_STlv_c_r
        struct[0].Gy_ini[98,101] = v_STlv_c_i
        struct[0].Gy_ini[99,18] = -i_STlv_a_i
        struct[0].Gy_ini[99,19] = i_STlv_a_r
        struct[0].Gy_ini[99,96] = v_STlv_a_i
        struct[0].Gy_ini[99,97] = -v_STlv_a_r
        struct[0].Gy_ini[100,20] = -i_STlv_b_i
        struct[0].Gy_ini[100,21] = i_STlv_b_r
        struct[0].Gy_ini[100,98] = v_STlv_b_i
        struct[0].Gy_ini[100,99] = -v_STlv_b_r
        struct[0].Gy_ini[101,22] = -i_STlv_c_i
        struct[0].Gy_ini[101,23] = i_STlv_c_r
        struct[0].Gy_ini[101,100] = v_STlv_c_i
        struct[0].Gy_ini[101,101] = -v_STlv_c_r
        struct[0].Gy_ini[102,18] = 1.0*v_STlv_a_r*(v_STlv_a_i**2 + v_STlv_a_r**2)**(-0.5)/V_base_STlv
        struct[0].Gy_ini[102,19] = 1.0*v_STlv_a_i*(v_STlv_a_i**2 + v_STlv_a_r**2)**(-0.5)/V_base_STlv
        struct[0].Gy_ini[103,54] = 1.0*v_STmv_a_r*(v_STmv_a_i**2 + v_STmv_a_r**2)**(-0.5)/V_base_STmv
        struct[0].Gy_ini[103,55] = 1.0*v_STmv_a_i*(v_STmv_a_i**2 + v_STmv_a_r**2)**(-0.5)/V_base_STmv
        struct[0].Gy_ini[104,102] = K_p_v_STlv*(u_ctrl_v_STlv - 1.0)
        struct[0].Gy_ini[104,103] = -K_p_v_STlv*u_ctrl_v_STlv
        struct[0].Gy_ini[105,58] = 1.0*S_base_STlv*v_STmv_c_r*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_STlv, I_max_STlv < -i_reac_ref_STlv), (I_max_STlv, I_max_STlv < i_reac_ref_STlv), (i_reac_ref_STlv, True)]))
        struct[0].Gy_ini[105,59] = 1.0*S_base_STlv*v_STmv_c_i*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_STlv, I_max_STlv < -i_reac_ref_STlv), (I_max_STlv, I_max_STlv < i_reac_ref_STlv), (i_reac_ref_STlv, True)]))
        struct[0].Gy_ini[105,104] = S_base_STlv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(0, (I_max_STlv < i_reac_ref_STlv) | (I_max_STlv < -i_reac_ref_STlv)), (1, True)]))
...
def run(t,struct,mode):
    ...
    v_m_W1lv = struct[0].y_run[72,0]
    v_m_W1mv = struct[0].y_run[73,0]
    i_reac_ref_W1lv = struct[0].y_run[74,0]
    q_ref_W1lv = struct[0].y_run[75,0]
    i_W2lv_a_r = struct[0].y_run[76,0]
    i_W2lv_a_i = struct[0].y_run[77,0]
    i_W2lv_b_r = struct[0].y_run[78,0]
    i_W2lv_b_i = struct[0].y_run[79,0]
    i_W2lv_c_r = struct[0].y_run[80,0]
    i_W2lv_c_i = struct[0].y_run[81,0]
    v_m_W2lv = struct[0].y_run[82,0]
    v_m_W2mv = struct[0].y_run[83,0]
    i_reac_ref_W2lv = struct[0].y_run[84,0]
    q_ref_W2lv = struct[0].y_run[85,0]
    i_W3lv_a_r = struct[0].y_run[86,0]
    i_W3lv_a_i = struct[0].y_run[87,0]
    i_W3lv_b_r = struct[0].y_run[88,0]
    i_W3lv_b_i = struct[0].y_run[89,0]
    i_W3lv_c_r = struct[0].y_run[90,0]
    i_W3lv_c_i = struct[0].y_run[91,0]
    v_m_W3lv = struct[0].y_run[92,0]
    v_m_W3mv = struct[0].y_run[93,0]
    i_reac_ref_W3lv = struct[0].y_run[94,0]
    q_ref_W3lv = struct[0].y_run[95,0]
    i_STlv_a_r = struct[0].y_run[96,0]
    i_STlv_a_i = struct[0].y_run[97,0]
    i_STlv_b_r = struct[0].y_run[98,0]
    i_STlv_b_i = struct[0].y_run[99,0]
    i_STlv_c_r = struct[0].y_run[100,0]
    i_STlv_c_i = struct[0].y_run[101,0]
    v_m_STlv = struct[0].y_run[102,0]
    v_m_STmv = struct[0].y_run[103,0]
    i_reac_ref_STlv = struct[0].y_run[104,0]
    q_ref_STlv = struct[0].y_run[105,0]
    ...
    if mode == 11:
        ...
        struct[0].Fy[3,75] = 1/(3*T_pq_W1lv)
        struct[0].Fy[4,75] = 1/(3*T_pq_W1lv)
        struct[0].Fy[5,75] = 1/(3*T_pq_W1lv)
        struct[0].Fy[9,85] = 1/(3*T_pq_W2lv)
        struct[0].Fy[10,85] = 1/(3*T_pq_W2lv)
        struct[0].Fy[11,85] = 1/(3*T_pq_W2lv)
        struct[0].Fy[15,95] = 1/(3*T_pq_W3lv)
        struct[0].Fy[16,95] = 1/(3*T_pq_W3lv)
        struct[0].Fy[17,95] = 1/(3*T_pq_W3lv)
        struct[0].Fy[21,105] = 1/(3*T_pq_STlv)
        struct[0].Fy[22,105] = 1/(3*T_pq_STlv)
        struct[0].Fy[23,105] = 1/(3*T_pq_STlv)
        ...
        struct[0].Gx[98,20] = -1
        struct[0].Gx[99,21] = -1
        struct[0].Gx[100,22] = -1
        struct[0].Gx[101,23] = -1
        ...
        struct[0].Gy[72,0] = 1.0*v_W1lv_a_r*(v_W1lv_a_i**2 + v_W1lv_a_r**2)**(-0.5)/V_base_W1lv
        struct[0].Gy[72,1] = 1.0*v_W1lv_a_i*(v_W1lv_a_i**2 + v_W1lv_a_r**2)**(-0.5)/V_base_W1lv
        struct[0].Gy[73,36] = 1.0*v_W1mv_a_r*(v_W1mv_a_i**2 + v_W1mv_a_r**2)**(-0.5)/V_base_W1mv
        struct[0].Gy[73,37] = 1.0*v_W1mv_a_i*(v_W1mv_a_i**2 + v_W1mv_a_r**2)**(-0.5)/V_base_W1mv
        struct[0].Gy[74,72] = K_p_v_W1lv*(u_ctrl_v_W1lv - 1.0)
        struct[0].Gy[74,73] = -K_p_v_W1lv*u_ctrl_v_W1lv
        struct[0].Gy[75,58] = 1.0*S_base_W1lv*v_STmv_c_r*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W1lv, I_max_W1lv < -i_reac_ref_W1lv), (I_max_W1lv, I_max_W1lv < i_reac_ref_W1lv), (i_reac_ref_W1lv, True)]))
        struct[0].Gy[75,59] = 1.0*S_base_W1lv*v_STmv_c_i*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W1lv, I_max_W1lv < -i_reac_ref_W1lv), (I_max_W1lv, I_max_W1lv < i_reac_ref_W1lv), (i_reac_ref_W1lv, True)]))
        struct[0].Gy[75,74] = S_base_W1lv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(0, (I_max_W1lv < i_reac_ref_W1lv) | (I_max_W1lv < -i_reac_ref_W1lv)), (1, True)]))
        struct[0].Gy[76,6] = i_W2lv_a_r
        struct[0].Gy[76,7] = i_W2lv_a_i
        struct[0].Gy[76,76] = v_W2lv_a_r
        struct[0].Gy[76,77] = v_W2lv_a_i
        struct[0].Gy[77,8] = i_W2lv_b_r
        struct[0].Gy[77,9] = i_W2lv_b_i
        struct[0].Gy[77,78] = v_W2lv_b_r
        struct[0].Gy[77,79] = v_W2lv_b_i
        struct[0].Gy[78,10] = i_W2lv_c_r
        struct[0].Gy[78,11] = i_W2lv_c_i
        struct[0].Gy[78,80] = v_W2lv_c_r
        struct[0].Gy[78,81] = v_W2lv_c_i
        struct[0].Gy[79,6] = -i_W2lv_a_i
        struct[0].Gy[79,7] = i_W2lv_a_r
        struct[0].Gy[79,76] = v_W2lv_a_i
        struct[0].Gy[79,77] = -v_W2lv_a_r
        struct[0].Gy[80,8] = -i_W2lv_b_i
        struct[0].Gy[80,9] = i_W2lv_b_r
        struct[0].Gy[80,78] = v_W2lv_b_i
        struct[0].Gy[80,79] = -v_W2lv_b_r
        struct[0].Gy[81,10] = -i_W2lv_c_i
        struct[0].Gy[81,11] = i_W2lv_c_r
        struct[0].Gy[81,80] = v_W2lv_c_i
        struct[0].Gy[81,81] = -v_W2lv_c_r
        struct[0].Gy[82,6] = 1.0*v_W2lv_a_r*(v_W2lv_a_i**2 + v_W2lv_a_r**2)**(-0.5)/V_base_W2lv
        struct[0].Gy[82,7] = 1.0*v_W2lv_a_i*(v_W2lv_a_i**2 + v_W2lv_a_r**2)**(-0.5)/V_base_W2lv
        struct[0].Gy[83,42] = 1.0*v_W2mv_a_r*(v_W2mv_a_i**2 + v_W2mv_a_r**2)**(-0.5)/V_base_W2mv
        struct[0].Gy[83,43] = 1.0*v_W2mv_a_i*(v_W2mv_a_i**2 + v_W2mv_a_r**2)**(-0.5)/V_base_W2mv
        struct[0].Gy[84,82] = K_p_v_W2lv*(u_ctrl_v_W2lv - 1.0)
        struct[0].Gy[84,83] = -K_p_v_W2lv*u_ctrl_v_W2lv
        struct[0].Gy[85,58] = 1.0*S_base_W2lv*v_STmv_c_r*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W2lv, I_max_W2lv < -i_reac_ref_W2lv), (I_max_W2lv, I_max_W2lv < i_reac_ref_W2lv), (i_reac_ref_W2lv, True)]))
        struct[0].Gy[85,59] = 1.0*S_base_W2lv*v_STmv_c_i*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W2lv, I_max_W2lv < -i_reac_ref_W2lv), (I_max_W2lv, I_max_W2lv < i_reac_ref_W2lv), (i_reac_ref_W2lv, True)]))
        struct[0].Gy[85,84] = S_base_W2lv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(0, (I_max_W2lv < i_reac_ref_W2lv) | (I_max_W2lv < -i_reac_ref_W2lv)), (1, True)]))
        struct[0].Gy[86,12] = i_W3lv_a_r
        struct[0].Gy[86,13] = i_W3lv_a_i
        struct[0].Gy[86,86] = v_W3lv_a_r
        struct[0].Gy[86,87] = v_W3lv_a_i
        struct[0].Gy[87,14] = i_W3lv_b_r
        struct[0].Gy[87,15] = i_W3lv_b_i
        struct[0].Gy[87,88] = v_W3lv_b_r
        struct[0].Gy[87,89] = v_W3lv_b_i
        struct[0].Gy[88,16] = i_W3lv_c_r
        struct[0].Gy[88,17] = i_W3lv_c_i
        struct[0].Gy[88,90] = v_W3lv_c_r
        struct[0].Gy[88,91] = v_W3lv_c_i
        struct[0].Gy[89,12] = -i_W3lv_a_i
        struct[0].Gy[89,13] = i_W3lv_a_r
        struct[0].Gy[89,86] = v_W3lv_a_i
        struct[0].Gy[89,87] = -v_W3lv_a_r
        struct[0].Gy[90,14] = -i_W3lv_b_i
        struct[0].Gy[90,15] = i_W3lv_b_r
        struct[0].Gy[90,88] = v_W3lv_b_i
        struct[0].Gy[90,89] = -v_W3lv_b_r
        struct[0].Gy[91,16] = -i_W3lv_c_i
        struct[0].Gy[91,17] = i_W3lv_c_r
        struct[0].Gy[91,90] = v_W3lv_c_i
        struct[0].Gy[91,91] = -v_W3lv_c_r
        struct[0].Gy[92,12] = 1.0*v_W3lv_a_r*(v_W3lv_a_i**2 + v_W3lv_a_r**2)**(-0.5)/V_base_W3lv
        struct[0].Gy[92,13] = 1.0*v_W3lv_a_i*(v_W3lv_a_i**2 + v_W3lv_a_r**2)**(-0.5)/V_base_W3lv
        struct[0].Gy[93,48] = 1.0*v_W3mv_a_r*(v_W3mv_a_i**2 + v_W3mv_a_r**2)**(-0.5)/V_base_W3mv
        struct[0].Gy[93,49] = 1.0*v_W3mv_a_i*(v_W3mv_a_i**2 + v_W3mv_a_r**2)**(-0.5)/V_base_W3mv
        struct[0].Gy[94,92] = K_p_v_W3lv*(u_ctrl_v_W3lv - 1.0)
        struct[0].Gy[94,93] = -K_p_v_W3lv*u_ctrl_v_W3lv
        struct[0].Gy[95,58] = 1.0*S_base_W3lv*v_STmv_c_r*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W3lv, I_max_W3lv < -i_reac_ref_W3lv), (I_max_W3lv, I_max_W3lv < i_reac_ref_W3lv), (i_reac_ref_W3lv, True)]))
        struct[0].Gy[95,59] = 1.0*S_base_W3lv*v_STmv_c_i*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_W3lv, I_max_W3lv < -i_reac_ref_W3lv), (I_max_W3lv, I_max_W3lv < i_reac_ref_W3lv), (i_reac_ref_W3lv, True)]))
        struct[0].Gy[95,94] = S_base_W3lv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(0, (I_max_W3lv < i_reac_ref_W3lv) | (I_max_W3lv < -i_reac_ref_W3lv)), (1, True)]))
        struct[0].Gy[96,18] = i_STlv_a_r
        struct[0].Gy[96,19] = i_STlv_a_i
        struct[0].Gy[96,96] = v_STlv_a_r
        struct[0].Gy[96,97] = v_STlv_a_i
        struct[0].Gy[97,20] = i_STlv_b_r
        struct[0].Gy[97,21] = i_STlv_b_i
        struct[0].Gy[97,98] = v_STlv_b_r
        struct[0].Gy[97,99] = v_STlv_b_i
        struct[0].Gy[98,22] = i_STlv_c_r
        struct[0].Gy[98,23] = i_STlv_c_i
        struct[0].Gy[98,100] = v_STlv_c_r
        struct[0].Gy[98,101] = v_STlv_c_i
        struct[0].Gy[99,18] = -i_STlv_a_i
        struct[0].Gy[99,19] = i_STlv_a_r
        struct[0].Gy[99,96] = v_STlv_a_i
        struct[0].Gy[99,97] = -v_STlv_a_r
        struct[0].Gy[100,20] = -i_STlv_b_i
        struct[0].Gy[100,21] = i_STlv_b_r
        struct[0].Gy[100,98] = v_STlv_b_i
        struct[0].Gy[100,99] = -v_STlv_b_r
        struct[0].Gy[101,22] = -i_STlv_c_i
        struct[0].Gy[101,23] = i_STlv_c_r
        struct[0].Gy[101,100] = v_STlv_c_i
        struct[0].Gy[101,101] = -v_STlv_c_r
        struct[0].Gy[102,18] = 1.0*v_STlv_a_r*(v_STlv_a_i**2 + v_STlv_a_r**2)**(-0.5)/V_base_STlv
        struct[0].Gy[102,19] = 1.0*v_STlv_a_i*(v_STlv_a_i**2 + v_STlv_a_r**2)**(-0.5)/V_base_STlv
        struct[0].Gy[103,54] = 1.0*v_STmv_a_r*(v_STmv_a_i**2 + v_STmv_a_r**2)**(-0.5)/V_base_STmv
        struct[0].Gy[103,55] = 1.0*v_STmv_a_i*(v_STmv_a_i**2 + v_STmv_a_r**2)**(-0.5)/V_base_STmv
        struct[0].Gy[104,102] = K_p_v_STlv*(u_ctrl_v_STlv - 1.0)
        struct[0].Gy[104,103] = -K_p_v_STlv*u_ctrl_v_STlv
        struct[0].Gy[105,58] = 1.0*S_base_STlv*v_STmv_c_r*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_STlv, I_max_STlv < -i_reac_ref_STlv), (I_max_STlv, I_max_STlv < i_reac_ref_STlv), (i_reac_ref_STlv, True)]))
        struct[0].Gy[105,59] = 1.0*S_base_STlv*v_STmv_c_i*(v_STmv_c_i**2 + v_STmv_c_r**2)**(-0.5)*Piecewise(np.array([(-I_max_STlv, I_max_STlv < -i_reac_ref_STlv), (I_max_STlv, I_max_STlv < i_reac_ref_STlv), (i_reac_ref_STlv, True)]))
        struct[0].Gy[105,104] = S_base_STlv*(v_STmv_c_i**2 + v_STmv_c_r**2)**0.5*Piecewise(np.array([(0, (I_max_STlv < i_reac_ref_STlv) | (I_max_STlv < -i_reac_ref_STlv)), (1, True)]))
    ...
    if mode > 12:
        ...
        struct[0].Gu[74,44] = K_p_v_W1lv
        struct[0].Gu[74,45] = K_p_v_W1lv
        struct[0].Gu[84,49] = K_p_v_W2lv
        struct[0].Gu[84,50] = K_p_v_W2lv
        struct[0].Gu[94,54] = K_p_v_W3lv
        struct[0].Gu[94,55] = K_p_v_W3lv
        struct[0].Gu[104,59] = K_p_v_STlv
        struct[0].Gu[104,60] = K_p_v_STlv
