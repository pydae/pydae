...
class grid_4bus4wire_class: 
    ...
    def __init__(self): 
        ...
        self.inputs_ini_values_list  = [231.0, 0.0, -115.49999999999994, -200.05186827420533, -115.5000000000001, 200.05186827420528, 231.0, 0.0, -115.49999999999994, -200.05186827420533, -115.5000000000001, 200.05186827420528, -0.007593639595967261, 0.09270649827460886, -151.8943758466279, 265.7197695224126, 0.0, 0.0, 0.0, 0.0, -30000.000000380038, 2.5480197507476987e-07, -30000.000000213677, -4.6439527068287134e-07, -29999.999999125506, 3.456352715147659e-07, -10000.00000050087, 3.5969150502523917e-07, -10000.000000137494, -6.140135155874304e-07, -79999.9999911452, 3.893503162544221e-06, 1.0] 
...
def ini(struct,mode):
    ...
    i_B2_a_r = struct[0].y_ini[20,0]
    i_B2_a_i = struct[0].y_ini[21,0]
    i_B2_b_r = struct[0].y_ini[22,0]
    i_B2_b_i = struct[0].y_ini[23,0]
    i_B2_c_r = struct[0].y_ini[24,0]
    i_B2_c_i = struct[0].y_ini[25,0]
    i_B2_n_r = struct[0].y_ini[26,0]
    i_B2_n_i = struct[0].y_ini[27,0]
    i_B3_a_r = struct[0].y_ini[28,0]
    i_B3_a_i = struct[0].y_ini[29,0]
    i_B3_b_r = struct[0].y_ini[30,0]
    i_B3_b_i = struct[0].y_ini[31,0]
    i_B3_c_r = struct[0].y_ini[32,0]
    i_B3_c_i = struct[0].y_ini[33,0]
    i_B3_n_r = struct[0].y_ini[34,0]
    i_B3_n_i = struct[0].y_ini[35,0]
    ...
    if mode == 11:
        ...
        struct[0].Gy_ini[20,0] = i_B2_a_r
        struct[0].Gy_ini[20,1] = i_B2_a_i
        struct[0].Gy_ini[20,6] = -i_B2_a_r
        struct[0].Gy_ini[20,7] = -i_B2_a_i
        struct[0].Gy_ini[20,20] = v_B2_a_r - v_B2_n_r
        struct[0].Gy_ini[20,21] = v_B2_a_i - v_B2_n_i
        struct[0].Gy_ini[21,2] = i_B2_b_r
        struct[0].Gy_ini[21,3] = i_B2_b_i
        struct[0].Gy_ini[21,6] = -i_B2_b_r
        struct[0].Gy_ini[21,7] = -i_B2_b_i
        struct[0].Gy_ini[21,22] = v_B2_b_r - v_B2_n_r
        struct[0].Gy_ini[21,23] = v_B2_b_i - v_B2_n_i
        struct[0].Gy_ini[22,4] = i_B2_c_r
        struct[0].Gy_ini[22,5] = i_B2_c_i
        struct[0].Gy_ini[22,6] = -i_B2_c_r
        struct[0].Gy_ini[22,7] = -i_B2_c_i
        struct[0].Gy_ini[22,24] = v_B2_c_r - v_B2_n_r
        struct[0].Gy_ini[22,25] = v_B2_c_i - v_B2_n_i
        struct[0].Gy_ini[23,0] = -i_B2_a_i
        struct[0].Gy_ini[23,1] = i_B2_a_r
        struct[0].Gy_ini[23,6] = i_B2_a_i
        struct[0].Gy_ini[23,7] = -i_B2_a_r
        struct[0].Gy_ini[23,20] = v_B2_a_i - v_B2_n_i
        struct[0].Gy_ini[23,21] = -v_B2_a_r + v_B2_n_r
        struct[0].Gy_ini[24,2] = -i_B2_b_i
        struct[0].Gy_ini[24,3] = i_B2_b_r
        struct[0].Gy_ini[24,6] = i_B2_b_i
        struct[0].Gy_ini[24,7] = -i_B2_b_r
        struct[0].Gy_ini[24,22] = v_B2_b_i - v_B2_n_i
        struct[0].Gy_ini[24,23] = -v_B2_b_r + v_B2_n_r
        struct[0].Gy_ini[25,4] = -i_B2_c_i
        struct[0].Gy_ini[25,5] = i_B2_c_r
        struct[0].Gy_ini[25,6] = i_B2_c_i
        struct[0].Gy_ini[25,7] = -i_B2_c_r
        struct[0].Gy_ini[25,24] = v_B2_c_i - v_B2_n_i
        struct[0].Gy_ini[25,25] = -v_B2_c_r + v_B2_n_r
        struct[0].Gy_ini[28,8] = i_B3_a_r
        struct[0].Gy_ini[28,9] = i_B3_a_i
        struct[0].Gy_ini[28,14] = -i_B3_a_r
        struct[0].Gy_ini[28,15] = -i_B3_a_i
        struct[0].Gy_ini[28,28] = v_B3_a_r - v_B3_n_r
        struct[0].Gy_ini[28,29] = v_B3_a_i - v_B3_n_i
        struct[0].Gy_ini[29,10] = i_B3_b_r
        struct[0].Gy_ini[29,11] = i_B3_b_i
        struct[0].Gy_ini[29,14] = -i_B3_b_r
        struct[0].Gy_ini[29,15] = -i_B3_b_i
        struct[0].Gy_ini[29,30] = v_B3_b_r - v_B3_n_r
        struct[0].Gy_ini[29,31] = v_B3_b_i - v_B3_n_i
        struct[0].Gy_ini[30,12] = i_B3_c_r
        struct[0].Gy_ini[30,13] = i_B3_c_i
        struct[0].Gy_ini[30,14] = -i_B3_c_r
        struct[0].Gy_ini[30,15] = -i_B3_c_i
        struct[0].Gy_ini[30,32] = v_B3_c_r - v_B3_n_r
        struct[0].Gy_ini[30,33] = v_B3_c_i - v_B3_n_i
        struct[0].Gy_ini[31,8] = -i_B3_a_i
        struct[0].Gy_ini[31,9] = i_B3_a_r
        struct[0].Gy_ini[31,14] = i_B3_a_i
        struct[0].Gy_ini[31,15] = -i_B3_a_r
        struct[0].Gy_ini[31,28] = v_B3_a_i - v_B3_n_i
        struct[0].Gy_ini[31,29] = -v_B3_a_r + v_B3_n_r
        struct[0].Gy_ini[32,10] = -i_B3_b_i
        struct[0].Gy_ini[32,11] = i_B3_b_r
        struct[0].Gy_ini[32,14] = i_B3_b_i
        struct[0].Gy_ini[32,15] = -i_B3_b_r
        struct[0].Gy_ini[32,30] = v_B3_b_i - v_B3_n_i
        struct[0].Gy_ini[32,31] = -v_B3_b_r + v_B3_n_r
        struct[0].Gy_ini[33,12] = -i_B3_c_i
        struct[0].Gy_ini[33,13] = i_B3_c_r
        struct[0].Gy_ini[33,14] = i_B3_c_i
        struct[0].Gy_ini[33,15] = -i_B3_c_r
...
def run(t,struct,mode):
    ...
    i_B2_a_r = struct[0].y_run[20,0]
    i_B2_a_i = struct[0].y_run[21,0]
    i_B2_b_r = struct[0].y_run[22,0]
    i_B2_b_i = struct[0].y_run[23,0]
    i_B2_c_r = struct[0].y_run[24,0]
    i_B2_c_i = struct[0].y_run[25,0]
    i_B2_n_r = struct[0].y_run[26,0]
    i_B2_n_i = struct[0].y_run[27,0]
    i_B3_a_r = struct[0].y_run[28,0]
    i_B3_a_i = struct[0].y_run[29,0]
    i_B3_b_r = struct[0].y_run[30,0]
    i_B3_b_i = struct[0].y_run[31,0]
    i_B3_c_r = struct[0].y_run[32,0]
    i_B3_c_i = struct[0].y_run[33,0]
    ...
    if mode == 11:
        ...
        struct[0].Gy[20,0] = i_B2_a_r
        struct[0].Gy[20,1] = i_B2_a_i
        struct[0].Gy[20,6] = -i_B2_a_r
        struct[0].Gy[20,7] = -i_B2_a_i
        struct[0].Gy[20,20] = v_B2_a_r - v_B2_n_r
        struct[0].Gy[20,21] = v_B2_a_i - v_B2_n_i
        struct[0].Gy[21,2] = i_B2_b_r
        struct[0].Gy[21,3] = i_B2_b_i
        struct[0].Gy[21,6] = -i_B2_b_r
        struct[0].Gy[21,7] = -i_B2_b_i
        struct[0].Gy[21,22] = v_B2_b_r - v_B2_n_r
        struct[0].Gy[21,23] = v_B2_b_i - v_B2_n_i
        struct[0].Gy[22,4] = i_B2_c_r
        struct[0].Gy[22,5] = i_B2_c_i
        struct[0].Gy[22,6] = -i_B2_c_r
        struct[0].Gy[22,7] = -i_B2_c_i
        struct[0].Gy[22,24] = v_B2_c_r - v_B2_n_r
        struct[0].Gy[22,25] = v_B2_c_i - v_B2_n_i
        struct[0].Gy[23,0] = -i_B2_a_i
        struct[0].Gy[23,1] = i_B2_a_r
        struct[0].Gy[23,6] = i_B2_a_i
        struct[0].Gy[23,7] = -i_B2_a_r
        struct[0].Gy[23,20] = v_B2_a_i - v_B2_n_i
        struct[0].Gy[23,21] = -v_B2_a_r + v_B2_n_r
        struct[0].Gy[24,2] = -i_B2_b_i
        struct[0].Gy[24,3] = i_B2_b_r
        struct[0].Gy[24,6] = i_B2_b_i
        struct[0].Gy[24,7] = -i_B2_b_r
        struct[0].Gy[24,22] = v_B2_b_i - v_B2_n_i
        struct[0].Gy[24,23] = -v_B2_b_r + v_B2_n_r
        struct[0].Gy[25,4] = -i_B2_c_i
        struct[0].Gy[25,5] = i_B2_c_r
        struct[0].Gy[25,6] = i_B2_c_i
        struct[0].Gy[25,7] = -i_B2_c_r
        struct[0].Gy[25,24] = v_B2_c_i - v_B2_n_i
        struct[0].Gy[25,25] = -v_B2_c_r + v_B2_n_r
        struct[0].Gy[28,8] = i_B3_a_r
        struct[0].Gy[28,9] = i_B3_a_i
        struct[0].Gy[28,14] = -i_B3_a_r
        struct[0].Gy[28,15] = -i_B3_a_i
        struct[0].Gy[28,28] = v_B3_a_r - v_B3_n_r
        struct[0].Gy[28,29] = v_B3_a_i - v_B3_n_i
        struct[0].Gy[29,10] = i_B3_b_r
        struct[0].Gy[29,11] = i_B3_b_i
        struct[0].Gy[29,14] = -i_B3_b_r
        struct[0].Gy[29,15] = -i_B3_b_i
        struct[0].Gy[29,30] = v_B3_b_r - v_B3_n_r
        struct[0].Gy[29,31] = v_B3_b_i - v_B3_n_i
        struct[0].Gy[30,12] = i_B3_c_r
        struct[0].Gy[30,13] = i_B3_c_i
        struct[0].Gy[30,14] = -i_B3_c_r
        struct[0].Gy[30,15] = -i_B3_c_i
        struct[0].Gy[30,32] = v_B3_c_r - v_B3_n_r
        struct[0].Gy[30,33] = v_B3_c_i - v_B3_n_i
        struct[0].Gy[31,8] = -i_B3_a_i
        struct[0].Gy[31,9] = i_B3_a_r
        struct[0].Gy[31,14] = i_B3_a_i
        struct[0].Gy[31,15] = -i_B3_a_r
        struct[0].Gy[31,28] = v_B3_a_i - v_B3_n_i
        struct[0].Gy[31,29] = -v_B3_a_r + v_B3_n_r
        struct[0].Gy[32,10] = -i_B3_b_i
        struct[0].Gy[32,11] = i_B3_b_r
        struct[0].Gy[32,14] = i_B3_b_i
        struct[0].Gy[32,15] = -i_B3_b_r
        struct[0].Gy[32,30] = v_B3_b_i - v_B3_n_i
        struct[0].Gy[32,31] = -v_B3_b_r + v_B3_n_r
        struct[0].Gy[33,12] = -i_B3_c_i
        struct[0].Gy[33,13] = i_B3_c_r
        struct[0].Gy[33,14] = i_B3_c_i
        struct[0].Gy[33,15] = -i_B3_c_r
