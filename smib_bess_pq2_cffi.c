...
out[0] = -2.7777777777777776e-7*p[6]*y[3]*y[4]/p[7];
out[1] = -x[0] + u[4];
out[2] = x[2] - u[5];
...
out[7] = -2.7777777777777776e-7*p[6]*y[4]/p[7];
out[8] = -2.7777777777777776e-7*p[6]*y[3]/p[7];
...
out[0] = -2.7777777777777776e-7*p[6]*y[4]/p[7];
out[1] = -2.7777777777777776e-7*p[6]*y[3]/p[7];
...
out[7] = 1.3888888888888888e-7*Dt*p[6]*y[4]/p[7];
out[8] = 1.3888888888888888e-7*Dt*p[6]*y[3]/p[7];
out[66] = 2.0*p[8]*p[2]*(-p[3]*x[1] - p[2]*(-x[0] + u[4]) + (((u[2] <= 0 || x[0] > p[4]) && (u[2] > 0 || x[0] < p[5]) && (x[0] > p[4] || x[0] < p[5])) ? (
   u[2]
)
: (
...
out[1] = 1.3888888888888888e-7*Dt*p[6]*y[4]/p[7];
out[2] = 1.3888888888888888e-7*Dt*p[6]*y[3]/p[7];
out[10] = 2.0*p[8]*p[2]*(-p[3]*x[1] - p[2]*(-x[0] + u[4]) + (((u[2] <= 0 || x[0] > p[4]) && (u[2] > 0 || x[0] < p[5]) && (x[0] > p[4] || x[0] < p[5])) ? (
   u[2]
)
: (
   0
...
out[11] = -2.0*p[8]*p[3]*(-p[3]*x[1] - p[2]*(-x[0] + u[4]) + (((u[2] <= 0 || x[0] > p[4]) && (u[2] > 0 || x[0] < p[5]) && (x[0] > p[4] || x[0] < p[5])) ? (
   u[2]
)
: (
   0
...
out[12] = -2.0*p[8]*pow(pow(u[3], 2) + pow(-p[3]*x[1] - p[2]*(-x[0] + u[4]) + (((u[2] <= 0 || x[0] > p[4]) && (u[2] > 0 || x[0] < p[5]) && (x[0] > p[4] || x[0] < p[5])) ? (
   u[2]
)
: (
   0
...
out[15] = y[4];
out[16] = y[3];
out[17] = p[12] + 2.0*p[13]*x[0] + 3.0*p[14]*pow(x[0], 2);
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_smib_bess_pq2_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_smib_bess_pq2_cffi(void) { return NULL; }
#  else
     initsmib_bess_pq2_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_smib_bess_pq2_cffi(void)
{
  return _cffi_init("smib_bess_pq2_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initsmib_bess_pq2_cffi(void)
{
  _cffi_init("smib_bess_pq2_cffi", 0x2601, &_cffi_type_context);
}
#endif
