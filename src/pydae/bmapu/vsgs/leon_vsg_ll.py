...
def test_build():
    ...
    data = {
        "system":{"name":"temp","S_base":100e6, "K_p_agc":0.0,"K_i_agc":0.01,"K_xif":1e-6},       
        "buses":[{"name":"1", "P_W":0.0,"Q_var":0.0,"U_kV":20.0},
                 {"name":"2", "P_W":0.0,"Q_var":0.0,"U_kV":20.0}],
        "lines":[{"bus_j":"1", "bus_k":"2", "X_pu":0.15,"R_pu":0.0, "S_mva":900.0}],
        # "vsgs":[
        #     {"bus":"1","type":"leon_vsg_ll",'S_n':10e6,'F_n':50,'K_delta':0.0,
        #     'R_v':0.01,'X_v':0.1,'K_p':1.0,'K_i':0.1,'K_g':0.0,'K_q':20.0,
        #     'T_q':0.1,'K_p_v':1e-6,'K_i_v':1e-6}],
        "sources":[{"type":"vsource","bus":"2","S_n":100e6,"F_n":50.0,"R_v":0.0,"X_v":0.1,"K_delta":0.001,"K_alpha":0.1}],
        }
