...
from pydae.bmapu.avrs.avr_kundur import avr_kundur
from pydae.bmapu.avrs.avr_kundur import avr_kundurq
...
def add_avr(dae,syn_data,name):
    ...
    if syn_data['avr']['type'] == 'avr_kundur':
        avr_kundur(dae,syn_data,name)
