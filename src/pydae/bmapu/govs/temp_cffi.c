...
: (
   ...
   p[44] > (p[27]*(1.0 - x[1]) + p[18]*y[10] - p[45] + u[7])/p[34]
)
: (
   ((p[46] > x[8]) ? (
      p[44] > (p[27]*(1.0 - x[1]) + p[18]*y[10] - p[46] + u[7])/p[34]
   )
   : (
      p[44] > (p[27]*(1.0 - x[1]) + p[18]*y[10] + u[7] - x[8])/p[34]
   ))
))) ? (
   p[44]
)
: ((((p[45] < x[8]) ? (
   p[43] < (p[27]*(1.0 - x[1]) + p[18]*y[10] - p[45] + u[7])/p[34]
)
: (
   ((p[46] > x[8]) ? (
      p[43] < (p[27]*(1.0 - x[1]) + p[18]*y[10] - p[46] + u[7])/p[34]
   )
   : (
      p[43] < (p[27]*(1.0 - x[1]) + p[18]*y[10] + u[7] - x[8])/p[34]
   ))
))) ? (
   p[43]
)
: (
   (p[27]*(1.0 - x[1]) + p[18]*y[10] + u[7] - ((p[45] < x[8]) ? (
      p[45]
   )
   : ((p[46] > x[8]) ? (
      p[46]
...
out[10] = (x[9] - x[10])/p[36];
out[11] = (x[10] - x[11])/p[37];
out[12] = -p[50]*x[12] - y[9] + 1;
...
out[8] = p[28]*x[9] + p[29]*x[10] + p[30]*x[11] - y[8];
out[9] = x[1] - y[9];
out[10] = p[49]*x[12] + p[48]*(1 - y[9]) - y[10];
...
out[200] = p[47]*(((p[46] > x[8] || p[45] < x[8]) ? (
   0
)
: (
   1.0
...
out[29] = ((p[46] > x[8] || p[45] < x[8]) ? (
   0
)
: (
   1.0
))/p[35];
out[37] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[38] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[39] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[40] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[42] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[43] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[44] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[49] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[50] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[51] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[52] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[53] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
...
out[67] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
out[68] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[69] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[70] = y[0]*sin(x[0] - y[1]);
out[71] = y[0]*cos(x[0] - y[1]);
out[73] = -y[0]*y[4]*sin(x[0] - y[1]) - y[0]*y[5]*cos(x[0] - y[1]);
out[74] = y[4]*cos(x[0] - y[1]) - y[5]*sin(x[0] - y[1]);
out[75] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]);
...
out[200] = -0.5*Dt*(p[47]*(((p[46] > x[8] || p[45] < x[8]) ? (
   0
)
: (
   1.0
...
out[224] = -0.5*Dt*((p[46] > x[8] || p[45] < x[8]) ? (
   0
)
: (
   1.0
...
out[225] = 0.5*Dt/p[35] + 1.0;
out[249] = -0.5*Dt/p[36];
out[250] = 0.5*Dt/p[36] + 1.0;
out[274] = -0.5*Dt/p[37];
out[275] = 0.5*Dt/p[37] + 1.0;
out[300] = 0.5*Dt*p[50] + 1.0;
out[310] = 0.5*Dt;
out[331] = -p[7]/p[0];
out[356] = -p[7]/p[0];
out[425] = p[13];
...
out[28] = -0.5*Dt*(p[47]*(((p[46] > x[8] || p[45] < x[8]) ? (
   0
)
: (
   1.0
...
out[30] = -0.5*Dt*((p[46] > x[8] || p[45] < x[8]) ? (
   0
)
: (
   1.0
))/p[35];
out[38] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[39] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[40] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[41] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[43] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[44] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[45] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[50] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[51] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[52] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[53] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[54] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
...
out[68] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
out[69] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[70] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[71] = y[0]*sin(x[0] - y[1]);
out[72] = y[0]*cos(x[0] - y[1]);
out[74] = -y[0]*y[4]*sin(x[0] - y[1]) - y[0]*y[5]*cos(x[0] - y[1]);
out[75] = y[4]*cos(x[0] - y[1]) - y[5]*sin(x[0] - y[1]);
out[76] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]);
...
out[31] = 0.5*Dt/p[35] + 1.0;
out[32] = -0.5*Dt/p[36];
out[33] = 0.5*Dt/p[36] + 1.0;
out[34] = -0.5*Dt/p[37];
out[35] = 0.5*Dt/p[37] + 1.0;
out[36] = 0.5*Dt*p[50] + 1.0;
out[37] = 0.5*Dt;
out[42] = -p[7]/p[0];
out[47] = -p[7]/p[0];
out[60] = p[13];
...
out[60] = (p[20]*p[23]*(1.0 - u[6])/p[24] + u[6]*((p[26] > p[20]*(x[5] + p[23]*(p[21]*x[6] - y[0] + u[5] + u[4] - x[5])/p[24]) || p[25] < p[20]*(x[5] + p[23]*(p[21]*x[6] - y[0] + u[5] + u[4] - x[5])/p[24])) ? (
   0
)
: (
   p[20]*p[23]/p[24]
)))/p[22];
out[61] = (p[20]*p[23]*(1.0 - u[6])/p[24] + u[6]*((p[26] > p[20]*(x[5] + p[23]*(p[21]*x[6] - y[0] + u[5] + u[4] - x[5])/p[24]) || p[25] < p[20]*(x[5] + p[23]*(p[21]*x[6] - y[0] + u[5] + u[4] - x[5])/p[24])) ? (
   0
)
: (
   p[20]*p[23]/p[24]
)))/p[22];
out[62] = (-p[20]*(x[5] + p[23]*(p[21]*x[6] - y[0] + u[5] + u[4] - x[5])/p[24]) + ((p[25] < p[20]*(x[5] + p[23]*(p[21]*x[6] - y[0] + u[5] + u[4] - x[5])/p[24])) ? (
   p[25]
)
: ((p[26] > p[20]*(x[5] + p[23]*(p[21]*x[6] - y[0] + u[5] + u[4] - x[5])/p[24])) ? (
   p[26]
