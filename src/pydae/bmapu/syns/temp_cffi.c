...
out[0] = -p[19]*x[0] + p[8]*(x[1] - y[8]);
out[1] = (1.0/2.0)*(-p[17]*(x[1] - y[8]) - y[4]*(p[18]*y[4] + y[0]*sin(x[0] - y[1])) - y[5]*(p[18]*y[5] + y[0]*cos(x[0] - y[1])) + u[4])/p[10];
...
out[8] = -x[8] + u[8];
out[9] = -p[31]*x[9] - y[8] + 1;
if (p[32] > p[34]*(-x[10] + u[11])) {
   out[10] = p[32];
}
else if (p[33] < p[34]*(-x[10] + u[11])) {
   out[10] = p[33];
}
else {
   out[10] = p[34]*(-x[10] + u[11]);
}
...
out[1] = -u[1]/p[0] + pow(y[0], 2)*u[10] + pow(y[0], 2)*x[10] + pow(y[0], 2)*(-p[2] - p[5] - 1.0/2.0*p[3]) + y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3])) - p[9]*y[7]/p[0];
out[2] = y[2] - u[8];
out[3] = y[3] - u[9];
...
out[8] = -y[8] + (p[10]*p[9]*x[1] + 1000000000000000.0)/(p[10]*p[9] + 1000000000000000.0);
out[9] = p[30]*x[9] + p[29]*(1 - y[8]) - y[9];
...
out[21] = 0.5*(-y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]))/p[10];
out[32] = 0.5*(-y[4]*sin(x[0] - y[1]) - y[5]*cos(x[0] - y[1]))/p[10];
out[33] = 0.5*(y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]))/p[10];
out[36] = 0.5*(-2.0*p[18]*y[4] - y[0]*sin(x[0] - y[1]))/p[10];
out[37] = 0.5*(-2.0*p[18]*y[5] - y[0]*cos(x[0] - y[1]))/p[10];
out[152] = (p[22]*(1.0 - u[7])*(1.0 - p[25]/p[26]) + u[7]*((p[28] > p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26]) || p[27] < p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26])) ? (
   0
)
: (
   p[22]*(1.0 - p[25]/p[26])
)))/p[24];
out[153] = (p[22]*p[23]*p[25]*(1.0 - u[7])/p[26] + u[7]*((p[28] > p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26]) || p[27] < p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26])) ? (
   0
)
: (
   p[22]*p[23]*p[25]/p[26]
)))/p[24];
out[158] = (-p[22]*p[25]*(1.0 - u[7])/p[26] + u[7]*((p[28] > p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26]) || p[27] < p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26])) ? (
   0
)
: (
   -p[22]*p[25]/p[26]
)))/p[24];
out[220] = ((p[32] > p[34]*(-x[10] + u[11]) || p[33] < p[34]*(-x[10] + u[11])) ? (
   0
)
: (
   -p[34]
));
out[242] = 2.0*y[0]*(p[1] + p[4]) + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[243] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[244] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[245] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[262] = pow(y[0], 2);
out[263] = 2.0*y[0]*u[10] + 2.0*y[0]*x[10] + 2.0*y[0]*(-p[2] - p[5] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[264] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[265] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[266] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[315] = y[0]*sin(x[0] - y[1]);
out[326] = -cos(x[0] - y[1]);
out[327] = -y[0]*sin(x[0] - y[1]);
out[336] = -y[0]*cos(x[0] - y[1]);
out[347] = -sin(x[0] - y[1]);
out[348] = y[0]*cos(x[0] - y[1]);
out[357] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
out[368] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[369] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[372] = y[0]*sin(x[0] - y[1]);
out[373] = y[0]*cos(x[0] - y[1]);
out[378] = -y[0]*y[4]*sin(x[0] - y[1]) - y[0]*y[5]*cos(x[0] - y[1]);
out[389] = y[4]*cos(x[0] - y[1]) - y[5]*sin(x[0] - y[1]);
out[390] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]);
out[393] = y[0]*cos(x[0] - y[1]);
out[394] = -y[0]*sin(x[0] - y[1]);
...
out[1] = p[8];
out[19] = -p[8];
out[22] = -0.5*p[17]/p[10];
out[40] = 0.5*p[17]/p[10];
out[44] = -p[21]/p[11];
out[49] = 1.0/p[11];
out[57] = (p[15] - p[13])/p[11];
out[66] = -1/p[12];
out[79] = (-p[16] + p[14])/p[12];
out[88] = -1/p[24];
out[95] = 1.0/p[24];
out[110] = -1/p[26];
out[111] = p[23]/p[26];
...
out[351] = -p[18];
out[352] = p[16];
out[400] = p[10]*p[9]/(p[10]*p[9] + 1000000000000000.0);
out[429] = p[30];
out[439] = -p[29];
...
out[28] = ((p[32] > p[34]*(-x[10] + u[11]) || p[33] < p[34]*(-x[10] + u[11])) ? (
   0
)
: (
   -p[34]
));
out[29] = 2.0*y[0]*(p[1] + p[4]) + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
...
out[34] = pow(y[0], 2);
out[35] = 2.0*y[0]*u[10] + 2.0*y[0]*x[10] + 2.0*y[0]*(-p[2] - p[5] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[36] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[37] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[38] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[42] = y[0]*sin(x[0] - y[1]);
out[44] = -cos(x[0] - y[1]);
out[45] = -y[0]*sin(x[0] - y[1]);
out[48] = -y[0]*cos(x[0] - y[1]);
out[50] = -sin(x[0] - y[1]);
out[51] = y[0]*cos(x[0] - y[1]);
out[54] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
out[55] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[56] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[57] = y[0]*sin(x[0] - y[1]);
out[58] = y[0]*cos(x[0] - y[1]);
out[60] = -y[0]*y[4]*sin(x[0] - y[1]) - y[0]*y[5]*cos(x[0] - y[1]);
out[61] = y[4]*cos(x[0] - y[1]) - y[5]*sin(x[0] - y[1]);
out[62] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]);
out[63] = y[0]*cos(x[0] - y[1]);
...
out[52] = -p[18];
out[53] = p[16];
out[66] = p[10]*p[9]/(p[10]*p[9] + 1000000000000000.0);
out[68] = p[30];
out[69] = -p[29];
...
out[21] = -0.25*Dt*(-y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]))/p[10];
out[32] = -0.25*Dt*(-y[4]*sin(x[0] - y[1]) - y[5]*cos(x[0] - y[1]))/p[10];
out[33] = -0.25*Dt*(y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]))/p[10];
out[36] = -0.25*Dt*(-2.0*p[18]*y[4] - y[0]*sin(x[0] - y[1]))/p[10];
out[37] = -0.25*Dt*(-2.0*p[18]*y[5] - y[0]*cos(x[0] - y[1]))/p[10];
out[152] = -0.5*Dt*(p[22]*(1.0 - u[7])*(1.0 - p[25]/p[26]) + u[7]*((p[28] > p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26]) || p[27] < p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26])) ? (
   0
)
: (
   p[22]*(1.0 - p[25]/p[26])
)))/p[24];
out[153] = -0.5*Dt*(p[22]*p[23]*p[25]*(1.0 - u[7])/p[26] + u[7]*((p[28] > p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26]) || p[27] < p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26])) ? (
   0
)
: (
   p[22]*p[23]*p[25]/p[26]
)))/p[24];
out[158] = -0.5*Dt*(-p[22]*p[25]*(1.0 - u[7])/p[26] + u[7]*((p[28] > p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26]) || p[27] < p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26])) ? (
   0
)
: (
   -p[22]*p[25]/p[26]
)))/p[24];
out[220] = -0.5*Dt*((p[32] > p[34]*(-x[10] + u[11]) || p[33] < p[34]*(-x[10] + u[11])) ? (
   0
)
: (
   -p[34]
...
out[1] = -0.5*Dt*p[8];
out[19] = 0.5*Dt*p[8];
out[22] = 0.25*p[17]*Dt/p[10] + 1.0;
out[40] = -0.25*p[17]*Dt/p[10];
out[44] = 0.5*Dt*p[21]/p[11] + 1.0;
out[49] = -0.5*Dt/p[11];
out[57] = -0.5*Dt*(p[15] - p[13])/p[11];
out[66] = 0.5*Dt/p[12] + 1.0;
out[79] = -0.5*Dt*(-p[16] + p[14])/p[12];
out[88] = 0.5*Dt/p[24] + 1.0;
out[95] = -0.5*Dt/p[24];
out[110] = 0.5*Dt/p[26] + 1.0;
out[111] = -0.5*Dt*p[23]/p[26];
out[116] = 0.5*Dt/p[26];
out[137] = 0.5*Dt;
out[154] = 0.5*Dt/p[24] + 1.0;
out[176] = 0.5*Dt + 1.0;
out[198] = 0.5*Dt*p[31] + 1.0;
out[208] = 0.5*Dt;
out[248] = -p[9]/p[0];
out[270] = -p[9]/p[0];
out[330] = -p[15];
...
out[29] = -0.5*Dt*((p[32] > p[34]*(-x[10] + u[11]) || p[33] < p[34]*(-x[10] + u[11])) ? (
   0
)
: (
   -p[34]
)) + 1.0;
out[30] = 2.0*y[0]*(p[1] + p[4]) + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[31] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[32] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[33] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[35] = pow(y[0], 2);
out[36] = 2.0*y[0]*u[10] + 2.0*y[0]*x[10] + 2.0*y[0]*(-p[2] - p[5] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[37] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[38] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[39] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[43] = y[0]*sin(x[0] - y[1]);
out[45] = -cos(x[0] - y[1]);
out[46] = -y[0]*sin(x[0] - y[1]);
out[49] = -y[0]*cos(x[0] - y[1]);
out[51] = -sin(x[0] - y[1]);
out[52] = y[0]*cos(x[0] - y[1]);
out[55] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
out[56] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[57] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[58] = y[0]*sin(x[0] - y[1]);
out[59] = y[0]*cos(x[0] - y[1]);
out[61] = -y[0]*y[4]*sin(x[0] - y[1]) - y[0]*y[5]*cos(x[0] - y[1]);
out[62] = y[4]*cos(x[0] - y[1]) - y[5]*sin(x[0] - y[1]);
out[63] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]);
out[64] = y[0]*cos(x[0] - y[1]);
...
out[53] = -p[18];
out[54] = p[16];
out[67] = p[10]*p[9]/(p[10]*p[9] + 1000000000000000.0);
out[69] = p[30];
out[70] = -p[29];
...
out[89] = (p[22]*p[25]*(1.0 - u[7])/p[26] + u[7]*((p[28] > p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26]) || p[27] < p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26])) ? (
   0
)
: (
   p[22]*p[25]/p[26]
)))/p[24];
out[90] = (p[22]*p[25]*(1.0 - u[7])/p[26] + u[7]*((p[28] > p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26]) || p[27] < p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26])) ? (
   0
)
: (
   p[22]*p[25]/p[26]
)))/p[24];
out[91] = (-p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26]) + ((p[27] < p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26])) ? (
   p[27]
)
: ((p[28] > p[22]*(x[5] + p[25]*(p[23]*x[6] - y[0] + u[6] + u[5] - x[5])/p[26])) ? (
   p[28]
...
out[131] = ((p[32] > p[34]*(-x[10] + u[11]) || p[33] < p[34]*(-x[10] + u[11])) ? (
   0
)
: (
   p[34]
...
out[22] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
...
out[20] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[21] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[24] = 2.0*p[18]*y[4] + y[0]*sin(x[0] - y[1]);
out[25] = 2.0*p[18]*y[5] + y[0]*cos(x[0] - y[1]);
...
out[8] = ((p[32] > p[34]*(-x[10] + u[11]) || p[33] < p[34]*(-x[10] + u[11])) ? (
   0
)
: (
   p[34]
