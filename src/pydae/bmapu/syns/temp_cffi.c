...
out[0] = -p[24]*x[0] + p[9]*(x[1] - y[8]);
out[1] = (1.0/2.0)*(-p[22]*(x[1] - y[8]) - y[4]*(p[23]*y[4] + y[0]*sin(x[0] - y[1])) - y[5]*(p[23]*y[5] + y[0]*cos(x[0] - y[1])) + u[5])/p[10];
out[2] = (-x[2] - y[4]*(-p[18] + p[16] - p[13]*p[20]*(-p[18] + p[16])/(p[11]*p[18])) + u[4]*(1 - p[26]/p[11]))/p[11];
out[3] = (-x[3] + y[5]*(-p[19] + p[17] - p[14]*p[21]*(-p[19] + p[17])/(p[12]*p[19])))/p[12];
out[4] = (x[2] - x[4] - y[4]*(p[18] - p[20] + p[13]*p[20]*(-p[18] + p[16])/(p[11]*p[18])) + p[26]*u[4]/p[11])/p[13];
out[5] = (x[3] - x[5] + y[5]*(p[19] - p[21] + p[14]*p[21]*(-p[19] + p[17])/(p[12]*p[19])))/p[14];
out[6] = -x[6] + u[6];
out[7] = -p[29]*x[7] - y[8] + 1;

}
void g_ini_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[0] = -u[0]/p[0] + pow(y[0], 2)*(p[1] + p[4]) + y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) - p[8]*y[6]/p[0];
out[1] = -u[1]/p[0] + pow(y[0], 2)*(-p[2] - p[5] - 1.0/2.0*p[3]) + y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3])) - p[8]*y[7]/p[0];
out[2] = y[2] - u[6];
out[3] = y[3] - u[7];
out[4] = p[23]*y[5] + y[0]*cos(x[0] - y[1]) + p[20]*y[4] - x[4];
out[5] = p[23]*y[4] + y[0]*sin(x[0] - y[1]) - p[21]*y[5] - x[5];
out[6] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]) - y[6];
out[7] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]) - y[7];
out[8] = -y[8] + (p[10]*p[8]*x[1] + 1000000000000000.0)/(p[10]*p[8] + 1000000000000000.0);
out[9] = p[28]*x[7] + p[27]*(1 - y[8]) - y[9];
...
out[0] = y[0];
out[1] = y[2];
out[2] = y[4]*(p[23]*y[4] + y[0]*sin(x[0] - y[1])) + y[5]*(p[23]*y[5] + y[0]*cos(x[0] - y[1]));
out[3] = u[4];
out[4] = x[6];
...
out[18] = 0.5*(-y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]))/p[10];
out[26] = 0.5*(-y[4]*sin(x[0] - y[1]) - y[5]*cos(x[0] - y[1]))/p[10];
out[27] = 0.5*(y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]))/p[10];
out[30] = 0.5*(-2.0*p[23]*y[4] - y[0]*sin(x[0] - y[1]))/p[10];
out[31] = 0.5*(-2.0*p[23]*y[5] - y[0]*cos(x[0] - y[1]))/p[10];
out[152] = 2.0*y[0]*(p[1] + p[4]) + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[153] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[154] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[155] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[170] = 2.0*y[0]*(-p[2] - p[5] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[171] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[172] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[173] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[216] = -y[0]*sin(x[0] - y[1]);
out[224] = cos(x[0] - y[1]);
out[225] = y[0]*sin(x[0] - y[1]);
out[234] = y[0]*cos(x[0] - y[1]);
out[242] = sin(x[0] - y[1]);
out[243] = -y[0]*cos(x[0] - y[1]);
out[252] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
out[260] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[261] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[264] = y[0]*sin(x[0] - y[1]);
out[265] = y[0]*cos(x[0] - y[1]);
out[270] = -y[0]*y[4]*sin(x[0] - y[1]) - y[0]*y[5]*cos(x[0] - y[1]);
out[278] = y[4]*cos(x[0] - y[1]) - y[5]*sin(x[0] - y[1]);
out[279] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]);
...
out[1] = p[9];
out[16] = -p[9];
out[19] = -0.5*p[22]/p[10];
out[34] = 0.5*p[22]/p[10];
out[38] = -1/p[11];
out[48] = (p[18] - p[16] + p[13]*p[20]*(-p[18] + p[16])/(p[11]*p[18]))/p[11];
out[57] = -1/p[12];
out[67] = (-p[19] + p[17] - p[14]*p[21]*(-p[19] + p[17])/(p[12]*p[19]))/p[12];
out[74] = 1.0/p[13];
out[76] = -1/p[13];
out[84] = (-p[18] + p[20] - p[13]*p[20]*(-p[18] + p[16])/(p[11]*p[18]))/p[13];
out[93] = 1.0/p[14];
out[95] = -1/p[14];
out[103] = (p[19] - p[21] + p[14]*p[21]*(-p[19] + p[17])/(p[12]*p[19]))/p[14];
out[133] = -p[29];
out[158] = -p[8]/p[0];
out[177] = -p[8]/p[0];
out[228] = p[20];
...
out[246] = p[23];
out[247] = -p[21];
out[289] = p[10]*p[8]/(p[10]*p[8] + 1000000000000000.0);
out[313] = p[28];
out[322] = -p[27];
...
out[7] = 0.5*(-2.0*p[23]*y[4] - y[0]*sin(x[0] - y[1]))/p[10];
out[8] = 0.5*(-2.0*p[23]*y[5] - y[0]*cos(x[0] - y[1]))/p[10];
out[23] = 2.0*y[0]*(p[1] + p[4]) + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
...
out[28] = 2.0*y[0]*(-p[2] - p[5] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[35] = -y[0]*sin(x[0] - y[1]);
out[37] = cos(x[0] - y[1]);
out[38] = y[0]*sin(x[0] - y[1]);
out[41] = y[0]*cos(x[0] - y[1]);
out[43] = sin(x[0] - y[1]);
out[44] = -y[0]*cos(x[0] - y[1]);
out[47] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
out[48] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[49] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[50] = y[0]*sin(x[0] - y[1]);
out[51] = y[0]*cos(x[0] - y[1]);
out[53] = -y[0]*y[4]*sin(x[0] - y[1]) - y[0]*y[5]*cos(x[0] - y[1]);
out[54] = y[4]*cos(x[0] - y[1]) - y[5]*sin(x[0] - y[1]);
out[55] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]);
...
out[9] = 0.5*p[22]/p[10];
out[10] = -1/p[11];
out[11] = (p[18] - p[16] + p[13]*p[20]*(-p[18] + p[16])/(p[11]*p[18]))/p[11];
out[12] = -1/p[12];
out[13] = (-p[19] + p[17] - p[14]*p[21]*(-p[19] + p[17])/(p[12]*p[19]))/p[12];
out[14] = 1.0/p[13];
out[15] = -1/p[13];
out[16] = (-p[18] + p[20] - p[13]*p[20]*(-p[18] + p[16])/(p[11]*p[18]))/p[13];
out[17] = 1.0/p[14];
out[18] = -1/p[14];
out[19] = (p[19] - p[21] + p[14]*p[21]*(-p[19] + p[17])/(p[12]*p[19]))/p[14];
out[21] = -p[29];
out[27] = -p[8]/p[0];
out[32] = -p[8]/p[0];
out[39] = p[20];
...
out[45] = p[23];
out[46] = -p[21];
out[59] = p[10]*p[8]/(p[10]*p[8] + 1000000000000000.0);
out[61] = p[28];
out[62] = -p[27];
...
out[18] = -0.25*Dt*(-y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]))/p[10];
out[26] = -0.25*Dt*(-y[4]*sin(x[0] - y[1]) - y[5]*cos(x[0] - y[1]))/p[10];
out[27] = -0.25*Dt*(y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]))/p[10];
out[30] = -0.25*Dt*(-2.0*p[23]*y[4] - y[0]*sin(x[0] - y[1]))/p[10];
out[31] = -0.25*Dt*(-2.0*p[23]*y[5] - y[0]*cos(x[0] - y[1]))/p[10];
out[152] = 2.0*y[0]*(p[1] + p[4]) + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[153] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[154] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[155] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[0] = 0.5*Dt*p[24] + 1.0;
out[1] = -0.5*Dt*p[9];
out[16] = 0.5*Dt*p[9];
out[19] = 0.25*p[22]*Dt/p[10] + 1.0;
out[34] = -0.25*p[22]*Dt/p[10];
out[38] = 0.5*Dt/p[11] + 1.0;
out[48] = -0.5*Dt*(p[18] - p[16] + p[13]*p[20]*(-p[18] + p[16])/(p[11]*p[18]))/p[11];
out[57] = 0.5*Dt/p[12] + 1.0;
out[67] = -0.5*Dt*(-p[19] + p[17] - p[14]*p[21]*(-p[19] + p[17])/(p[12]*p[19]))/p[12];
out[74] = -0.5*Dt/p[13];
out[76] = 0.5*Dt/p[13] + 1.0;
out[84] = -0.5*Dt*(-p[18] + p[20] - p[13]*p[20]*(-p[18] + p[16])/(p[11]*p[18]))/p[13];
out[93] = -0.5*Dt/p[14];
out[95] = 0.5*Dt/p[14] + 1.0;
out[103] = -0.5*Dt*(p[19] - p[21] + p[14]*p[21]*(-p[19] + p[17])/(p[12]*p[19]))/p[14];
out[114] = 0.5*Dt + 1.0;
out[133] = 0.5*Dt*p[29] + 1.0;
out[142] = 0.5*Dt;
out[158] = -p[8]/p[0];
out[177] = -p[8]/p[0];
out[228] = p[20];
...
out[7] = -0.25*Dt*(-2.0*p[23]*y[4] - y[0]*sin(x[0] - y[1]))/p[10];
out[8] = -0.25*Dt*(-2.0*p[23]*y[5] - y[0]*cos(x[0] - y[1]))/p[10];
out[23] = 2.0*y[0]*(p[1] + p[4]) + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[24] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[25] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[26] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[1] = -0.5*Dt*p[9];
out[2] = 0.5*Dt*p[9];
out[4] = 0.25*p[22]*Dt/p[10] + 1.0;
out[9] = -0.25*p[22]*Dt/p[10];
out[10] = 0.5*Dt/p[11] + 1.0;
out[11] = -0.5*Dt*(p[18] - p[16] + p[13]*p[20]*(-p[18] + p[16])/(p[11]*p[18]))/p[11];
out[12] = 0.5*Dt/p[12] + 1.0;
out[13] = -0.5*Dt*(-p[19] + p[17] - p[14]*p[21]*(-p[19] + p[17])/(p[12]*p[19]))/p[12];
out[14] = -0.5*Dt/p[13];
out[15] = 0.5*Dt/p[13] + 1.0;
out[16] = -0.5*Dt*(-p[18] + p[20] - p[13]*p[20]*(-p[18] + p[16])/(p[11]*p[18]))/p[13];
out[17] = -0.5*Dt/p[14];
out[18] = 0.5*Dt/p[14] + 1.0;
out[19] = -0.5*Dt*(p[19] - p[21] + p[14]*p[21]*(-p[19] + p[17])/(p[12]*p[19]))/p[14];
out[20] = 0.5*Dt + 1.0;
out[21] = 0.5*Dt*p[29] + 1.0;
out[22] = 0.5*Dt;
out[27] = -p[8]/p[0];
out[32] = -p[8]/p[0];
out[39] = p[20];
...
out[13] = 0.5/p[10];
out[20] = (1.0 - p[26]/p[11])/p[11];
out[36] = p[26]/(p[11]*p[13]);
...
out[24] = 2.0*p[23]*y[4] + y[0]*sin(x[0] - y[1]);
out[25] = 2.0*p[23]*y[5] + y[0]*cos(x[0] - y[1]);
...
out[0] = 0.5/p[10];
out[1] = (1.0 - p[26]/p[11])/p[11];
out[2] = p[26]/(p[11]*p[13]);
...
out[4] = 2.0*p[23]*y[4] + y[0]*sin(x[0] - y[1]);
out[5] = 2.0*p[23]*y[5] + y[0]*cos(x[0] - y[1]);
