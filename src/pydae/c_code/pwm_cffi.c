...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_pwm_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_pwm_cffi(void) { return NULL; }
#  else
     initpwm_cffi(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_pwm_cffi(void)
{
  return _cffi_init("pwm_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initpwm_cffi(void)
{
  _cffi_init("pwm_cffi", 0x2601, &_cffi_type_context);
}
#endif
