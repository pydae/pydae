#ifndef DAE_RUN_DENSE_H
#define DAE_RUN_DENSE_H

// Core linear solver (replaces MKL PARDISO wrapper)
int solve_dense(double *A, int N, int *pivots, double *b, double *x, int flag);

// Evaluation function signatures (You will need to implement the dense versions of these)
...
// Dense Jacobian evaluation signatures
//void jac_trap_num_eval(double *out, double *x, double *y, double *u, double *p, double Dt);
//void jac_trap_up_eval(double *out, double *x, double *y, double *u, double *p, double Dt);
//void jac_trap_xy_eval(double *out, double *x, double *y, double *u, double *p, double Dt);
void jac_trap_eval(double *out, double *x, double *y, double *u, double *p, double Dt);
void jac_run_eval(double *out, double *x, double *y, double *u, double *p, double Dt);
