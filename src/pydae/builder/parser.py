...
def process_system_dict(sys):
    ...
    for expr in all_exprs:
        # Check if the expression is a SymPy object with free_symbols
    ...
    def get_sym(item):
        ...
        if isinstance(item, sym.Symbol):
            return item  # It's already symbolic!
    ...
    # SymPy's Matrix natively accepts lists of SymPy expressions
    ...
    if 'h_dict' in sys:
        ...
        # Default fallback: outputs are the algebraic variables
