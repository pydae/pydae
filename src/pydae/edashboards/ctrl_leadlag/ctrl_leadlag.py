...
if dae_file_mode == 'local':
    import ctrl_leadlag_cffi as jacs
if dae_file_mode == 'enviroment':
    import envus.no_enviroment.ctrl_leadlag_cffi as jacs
if dae_file_mode == 'colab':
    import ctrl_leadlag_cffi as jacs
if dae_file_mode == 'testing':
    from pydae.temp import ctrl_leadlag_cffi as jacs
...
class model: 
    ...
    def __init__(self,matrices_folder='./build'): 
        ...
        self.N_z = 3 
        self.N_store = 100000 
        self.params_list = ['T_1', 'T_2', 'omega', 'K_sin'] 
        self.params_values_list  = [1.0, 1.0, 62.83185307179586, 0.0] 
        self.inputs_ini_list = ['u_12', 'timer', 'u_dummy'] 
        self.inputs_ini_values_list  = [0.0, 0.0, 1.0] 
        self.inputs_run_list = ['u_12', 'timer', 'u_dummy'] 
        self.inputs_run_values_list = [0.0, 0.0, 1.0] 
        self.outputs_list = ['z', 'u', 't_1'] 
        self.x_list = ['x_12', 't_1'] 
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, f'./ctrl_leadlag_sp_jac_ini_num.npz'))
            self.sp_jac_ini = sspa.load_npz(fobj)
        else:
            self.sp_jac_ini = sspa.load_npz(f'{self.matrices_folder}/ctrl_leadlag_sp_jac_ini_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './ctrl_leadlag_sp_jac_run_num.npz'))
            self.sp_jac_run = sspa.load_npz(fobj)
        else:
            self.sp_jac_run = sspa.load_npz(f'{self.matrices_folder}/ctrl_leadlag_sp_jac_run_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            fobj = BytesIO(pkgutil.get_data(__name__, './ctrl_leadlag_sp_jac_trap_num.npz'))
            self.sp_jac_trap = sspa.load_npz(fobj)
        else:
            self.sp_jac_trap = sspa.load_npz(f'{self.matrices_folder}/ctrl_leadlag_sp_jac_trap_num.npz')
        ...
        #self.sp_Fu_run = sspa.load_npz(f'{self.matrices_folder}/ctrl_leadlag_Fu_run_num.npz')
        #self.sp_Gu_run = sspa.load_npz(f'{self.matrices_folder}/ctrl_leadlag_Gu_run_num.npz')
        #self.sp_Hx_run = sspa.load_npz(f'{self.matrices_folder}/ctrl_leadlag_Hx_run_num.npz')
        #self.sp_Hy_run = sspa.load_npz(f'{self.matrices_folder}/ctrl_leadlag_Hy_run_num.npz')
        #self.sp_Hu_run = sspa.load_npz(f'{self.matrices_folder}/ctrl_leadlag_Hu_run_num.npz')        
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 1, 2]
    sp_jac_ini_ja = [0, 2, 3, 4]
    sp_jac_ini_nia = 3
    sp_jac_ini_nja = 3
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 1, 2]
    sp_jac_run_ja = [0, 2, 3, 4]
    sp_jac_run_nia = 3
    sp_jac_run_nja = 3
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 1, 2]
    sp_jac_trap_ja = [0, 2, 3, 4]
    sp_jac_trap_nia = 3
    sp_jac_trap_nja = 3
