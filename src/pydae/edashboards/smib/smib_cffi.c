...
out[0] = -p[17]*x[0] + p[6]*(x[1] - y[8]);
out[1] = (1.0/2.0)*(-p[15]*(x[1] - y[8]) - y[4]*(p[16]*y[4] + y[0]*sin(x[0] - y[1])) - y[5]*(p[16]*y[5] + y[0]*cos(x[0] - y[1])) + u[5])/p[8];
out[2] = (-x[2] - y[4]*(-p[13] + p[11]) + u[4])/p[9];
out[3] = (-x[3] + y[5]*(-p[14] + p[12]))/p[10];
out[4] = -p[21]*x[4] - y[8] + 1;
...
out[15] = 0.5*(-y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]))/p[8];
out[20] = 0.5*(-y[4]*sin(x[0] - y[1]) - y[5]*cos(x[0] - y[1]))/p[8];
out[21] = 0.5*(y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]))/p[8];
out[24] = 0.5*(-2.0*p[16]*y[4] - y[0]*sin(x[0] - y[1]))/p[8];
out[25] = 0.5*(-2.0*p[16]*y[5] - y[0]*cos(x[0] - y[1]))/p[8];
out[80] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[81] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[82] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[83] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[110] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[111] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[112] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[113] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[125] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[126] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[127] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
out[128] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[135] = -y[0]*sin(x[0] - y[1]);
out[140] = cos(x[0] - y[1]);
out[141] = y[0]*sin(x[0] - y[1]);
out[150] = y[0]*cos(x[0] - y[1]);
out[155] = sin(x[0] - y[1]);
out[156] = -y[0]*cos(x[0] - y[1]);
out[165] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
out[170] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[171] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[174] = y[0]*sin(x[0] - y[1]);
out[175] = y[0]*cos(x[0] - y[1]);
out[180] = -y[0]*y[4]*sin(x[0] - y[1]) - y[0]*y[5]*cos(x[0] - y[1]);
out[185] = y[4]*cos(x[0] - y[1]) - y[5]*sin(x[0] - y[1]);
out[186] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]);
out[189] = y[0]*cos(x[0] - y[1]);
out[190] = -y[0]*sin(x[0] - y[1]);
...
out[28] = 0.5*p[15]/p[8];
out[32] = -1/p[9];
out[39] = (p[13] - p[11])/p[9];
out[48] = -1/p[10];
out[55] = (-p[14] + p[12])/p[10];
out[64] = -p[21];
out[86] = -p[7]/p[0];
out[102] = -p[7]/p[0];
out[144] = p[13];
...
out[16] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[17] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[18] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[19] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[21] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[22] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[23] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[24] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[26] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[27] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[28] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
...
out[34] = -y[0]*sin(x[0] - y[1]);
out[36] = cos(x[0] - y[1]);
out[37] = y[0]*sin(x[0] - y[1]);
out[40] = y[0]*cos(x[0] - y[1]);
out[42] = sin(x[0] - y[1]);
out[43] = -y[0]*cos(x[0] - y[1]);
out[46] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
out[47] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[48] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[49] = y[0]*sin(x[0] - y[1]);
out[50] = y[0]*cos(x[0] - y[1]);
out[52] = -y[0]*y[4]*sin(x[0] - y[1]) - y[0]*y[5]*cos(x[0] - y[1]);
out[53] = y[4]*cos(x[0] - y[1]) - y[5]*sin(x[0] - y[1]);
out[54] = y[0]*y[4]*sin(x[0] - y[1]) + y[0]*y[5]*cos(x[0] - y[1]);
out[55] = y[0]*cos(x[0] - y[1]);
...
out[15] = -0.25*Dt*(-y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]))/p[8];
out[20] = -0.25*Dt*(-y[4]*sin(x[0] - y[1]) - y[5]*cos(x[0] - y[1]))/p[8];
out[21] = -0.25*Dt*(y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]))/p[8];
out[24] = -0.25*Dt*(-2.0*p[16]*y[4] - y[0]*sin(x[0] - y[1]))/p[8];
out[25] = -0.25*Dt*(-2.0*p[16]*y[5] - y[0]*cos(x[0] - y[1]))/p[8];
out[80] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[81] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[82] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[83] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[1] = -0.5*Dt*p[6];
out[13] = 0.5*Dt*p[6];
out[16] = 0.25*p[15]*Dt/p[8] + 1.0;
out[28] = -0.25*p[15]*Dt/p[8];
out[32] = 0.5*Dt/p[9] + 1.0;
out[39] = -0.5*Dt*(p[13] - p[11])/p[9];
out[48] = 0.5*Dt/p[10] + 1.0;
out[55] = -0.5*Dt*(-p[14] + p[12])/p[10];
out[64] = 0.5*Dt*p[21] + 1.0;
out[73] = 0.5*Dt;
out[86] = -p[7]/p[0];
out[102] = -p[7]/p[0];
out[144] = p[13];
...
out[10] = y[0]*y[4]*cos(x[0] - y[1]) - y[0]*y[5]*sin(x[0] - y[1]);
...
out[24] = 2.0*p[16]*y[4] + y[0]*sin(x[0] - y[1]);
out[25] = 2.0*p[16]*y[5] + y[0]*cos(x[0] - y[1]);
