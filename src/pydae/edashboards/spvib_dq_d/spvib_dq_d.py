...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 8 
        self.N_store = 100000 
        self.params_list = ['S_base', 'g_POI_GRID', 'b_POI_GRID', 'bs_POI_GRID', 'U_POI_n', 'U_GRID_n', 'S_n_GRID', 'F_n_GRID', 'X_v_GRID', 'R_v_GRID', 'K_delta_GRID', 'K_alpha_GRID', 'K_rocov_GRID', 'I_sc_POI', 'I_mp_POI', 'V_mp_POI', 'V_oc_POI', 'N_pv_s_POI', 'N_pv_p_POI', 'K_vt_POI', 'K_it_POI', 'v_lvrt_POI', 'T_lp1p_POI', 'T_lp2p_POI', 'T_lp1q_POI', 'T_lp2q_POI', 'PRampUp_POI', 'PRampDown_POI', 'QRampUp_POI', 'QRampDown_POI', 'S_n_POI', 'F_n_POI', 'U_n_POI', 'X_s_POI', 'R_s_POI', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [100000000.0, 0.0, -1.0, -0.0, 400.0, 400.0, 1000000000.0, 50.0, 0.001, 0.0, 0.001, 1e-06, 1e-06, 8, 3.56, 33.7, 42.1, 25, 250, -0.16, 0.065, 0.8, 0.1, 0.1, 0.1, 0.1, 2.5, -2.5, 2.5, -2.5, 1000000.0, 50.0, 400.0, 0.1, 0.01, 0.0, 0.0, 0.01] 
