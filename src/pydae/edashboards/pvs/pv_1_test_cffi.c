...
out[0] = 6.2831853071795862*p[7]*(y[4] - y[19]) - p[10]*(x[0] - u[7]);
out[1] = -x[1]*p[11] + u[4];
out[2] = -x[2]*p[12] + u[9];
out[3] = (0.070710678118654752*y[9] - 0.5*(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/(x[3] + 9.9999999999999995e-7))/p[26];
out[4] = -p[32]*x[4] - y[19] + 1;

}
void g_ini_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[0] = -u[0]/p[0] + pow(y[0], 2)*p[1] + y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) - 1000000.0*y[17]/p[0];
out[1] = -u[1]/p[0] + pow(y[0], 2)*(-p[2] - 1.0/2.0*p[3]) + y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3])) - 1000000.0*y[18]/p[0];
...
out[9] = -y[9] + (1.0/1000.0)*u[10]*((p[14] - (-1.0/1000.0*p[14]*p[21]*u[10]*((1.0/100.0)*p[20]*(u[11] - 25.0) + 1) + p[19]*(u[11] - 25.0) + p[17])/p[22])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))*exp(38.89108321788833*(p[19]*(u[11] - 25.0) + p[17])/(p[23]*p[18])) + (p[19]*(u[11] - 25.0) + p[17])/p[22]) - (p[14] - (-1.0/1000.0*p[14]*p[21]*u[10]*((1.0/100.0)*p[20]*(u[11] - 25.0) + 1) + p[19]*(u[11] - 25.0) + p[17])/p[22])*(exp(38.89108321788833*(p[21]*y[9] + 22.627416997969522*x[3])/(p[23]*p[18])) - 1)*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18])) - (p[21]*y[9] + 22.627416997969522*x[3])/p[22];
out[10] = -p[24]*(-x[3] + u[12]) - y[10];
out[11] = y[12]*(y[0]*pow(sin(y[1]), 2) + y[0]*pow(cos(y[1]), 2)) - y[10];
out[12] = -y[11]*(y[0]*pow(sin(y[1]), 2) + y[0]*pow(cos(y[1]), 2)) - u[13];
out[13] = -p[21]*(u[15] + y[11]) - p[25]*(u[16] + y[12]) + y[13];
out[14] = -p[21]*(u[16] + y[12]) - y[0]*pow(sin(y[1]), 2) - y[0]*pow(cos(y[1]), 2) + p[25]*(u[15] + y[11]) + y[14];
out[15] = -p[21]*y[15] - y[0]*sin(y[1]) - p[25]*y[16] + y[13]*cos(y[1]) + y[14]*sin(y[1]);
out[16] = -p[21]*y[16] - y[0]*cos(y[1]) + p[25]*y[15] - y[13]*sin(y[1]) + y[14]*cos(y[1]);
out[17] = y[0]*y[15]*sin(y[1]) + y[0]*y[16]*cos(y[1]) - y[17];
out[18] = -y[0]*y[15]*cos(y[1]) + y[0]*y[16]*sin(y[1]) - y[18];
out[19] = 1.0*y[4] - y[19];
out[20] = p[31]*x[4] + p[30]*(1 - y[19]) - y[20];
...
out[6] = u[4];
out[7] = x[2];
out[8] = 22.627416997969522*x[3];
out[9] = 22.627416997969522*y[9]*x[3];
out[10] = u[15] + y[11];
out[11] = u[16] + y[12];
out[12] = y[17];
out[13] = y[18];
out[14] = y[15];
out[15] = y[16];
out[16] = (y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/x[3];
out[17] = sqrt(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2))/x[3];
out[18] = atan2(y[13]*cos(y[1]) + y[14]*sin(y[1]), -y[13]*sin(y[1]) + y[14]*cos(y[1]));
out[19] = 0.1414213562373095*y[9];
out[20] = 250*y[9];

}
void de_jac_ini_xy_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[81] = 0.5*(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/(p[26]*pow(x[3] + 9.9999999999999995e-7, 2));
out[84] = -0.5*(y[15]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])) + y[16]*(-y[13]*cos(y[1]) - y[14]*sin(y[1])))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[96] = -0.5*(y[15]*cos(y[1]) - y[16]*sin(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[97] = -0.5*(y[15]*sin(y[1]) + y[16]*cos(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[98] = -0.5*(y[13]*cos(y[1]) + y[14]*sin(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[99] = -0.5*(-y[13]*sin(y[1]) + y[14]*cos(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[135] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[136] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[137] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[138] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[161] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[162] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[163] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[164] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[187] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[188] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[189] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[190] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[213] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[214] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[215] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
out[216] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[260] = -y[2]*cos(x[0] + u[8] - y[3]);
out[267] = -sin(x[0] + u[8] - y[3]);
out[268] = y[2]*cos(x[0] + u[8] - y[3]);
out[286] = y[2]*sin(x[0] + u[8] - y[3]);
out[293] = -cos(x[0] + u[8] - y[3]);
out[294] = -y[2]*sin(x[0] + u[8] - y[3]);
out[312] = y[2]*y[5]*cos(x[0] + u[8] - y[3]) - y[2]*y[6]*sin(x[0] + u[8] - y[3]);
out[319] = y[5]*sin(x[0] + u[8] - y[3]) + y[6]*cos(x[0] + u[8] - y[3]);
out[320] = -y[2]*y[5]*cos(x[0] + u[8] - y[3]) + y[2]*y[6]*sin(x[0] + u[8] - y[3]);
out[322] = y[2]*sin(x[0] + u[8] - y[3]);
out[323] = y[2]*cos(x[0] + u[8] - y[3]);
out[338] = -y[2]*y[5]*sin(x[0] + u[8] - y[3]) - y[2]*y[6]*cos(x[0] + u[8] - y[3]);
out[345] = y[5]*cos(x[0] + u[8] - y[3]) - y[6]*sin(x[0] + u[8] - y[3]);
out[346] = y[2]*y[5]*sin(x[0] + u[8] - y[3]) + y[2]*y[6]*cos(x[0] + u[8] - y[3]);
out[348] = y[2]*cos(x[0] + u[8] - y[3]);
out[349] = -y[2]*sin(x[0] + u[8] - y[3]);
out[367] = -22.627416997969522/p[22] - 880.00475747389362*(p[14] - (-0.001*p[14]*p[21]*u[10]*(0.01*p[20]*(u[11] - 25.0) + 1.0) + p[19]*(u[11] - 25.0) + p[17])/p[22])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))*exp(38.89108321788833*(p[21]*y[9] + 22.627416997969522*x[3])/(p[23]*p[18]))/(p[23]*p[18]);
out[378] = -p[21]/p[22] - 1.0 - 38.89108321788833*p[21]*(p[14] - (-0.001*p[14]*p[21]*u[10]*(0.01*p[20]*(u[11] - 25.0) + 1.0) + p[19]*(u[11] - 25.0) + p[17])/p[22])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))*exp(38.89108321788833*(p[21]*y[9] + 22.627416997969522*x[3])/(p[23]*p[18]))/(p[23]*p[18]);
out[421] = y[12]*(pow(sin(y[1]), 2) + pow(cos(y[1]), 2));
out[433] = y[0]*pow(sin(y[1]), 2) + y[0]*pow(cos(y[1]), 2);
out[447] = -y[11]*(pow(sin(y[1]), 2) + pow(cos(y[1]), 2));
out[458] = -y[0]*pow(sin(y[1]), 2) - y[0]*pow(cos(y[1]), 2);
out[499] = -pow(sin(y[1]), 2) - pow(cos(y[1]), 2);
out[525] = -sin(y[1]);
out[526] = -y[0]*cos(y[1]) - y[13]*sin(y[1]) + y[14]*cos(y[1]);
out[538] = cos(y[1]);
out[539] = sin(y[1]);
out[551] = -cos(y[1]);
out[552] = y[0]*sin(y[1]) - y[13]*cos(y[1]) - y[14]*sin(y[1]);
out[564] = -sin(y[1]);
out[565] = cos(y[1]);
out[577] = y[15]*sin(y[1]) + y[16]*cos(y[1]);
out[578] = y[0]*y[15]*cos(y[1]) - y[0]*y[16]*sin(y[1]);
out[592] = y[0]*sin(y[1]);
out[593] = y[0]*cos(y[1]);
out[603] = -y[15]*cos(y[1]) + y[16]*sin(y[1]);
out[604] = y[0]*y[15]*sin(y[1]) + y[0]*y[16]*cos(y[1]);
out[618] = -y[0]*cos(y[1]);
out[619] = y[0]*sin(y[1]);
...
out[0] = -p[10];
out[9] = 6.2831853071795862*p[7];
out[24] = -6.2831853071795862*p[7];
out[27] = -p[11];
out[54] = -p[12];
out[92] = 0.070710678118654752/p[26];
out[108] = -p[32];
out[152] = -1000000.0/p[0];
out[179] = -1000000.0/p[0];
out[194] = -p[6]/p[0];
out[221] = -p[6]/p[0];
out[270] = -p[9];
out[271] = p[8];
...
out[5] = 0.5*(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/(p[26]*pow(x[3] + 9.9999999999999995e-7, 2));
out[6] = -0.5*(y[15]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])) + y[16]*(-y[13]*cos(y[1]) - y[14]*sin(y[1])))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[8] = -0.5*(y[15]*cos(y[1]) - y[16]*sin(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[9] = -0.5*(y[15]*sin(y[1]) + y[16]*cos(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[10] = -0.5*(y[13]*cos(y[1]) + y[14]*sin(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[11] = -0.5*(-y[13]*sin(y[1]) + y[14]*cos(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[14] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[15] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[16] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[17] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[19] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[20] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[21] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[22] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[24] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[25] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[26] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[27] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[29] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[30] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[31] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
out[32] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[36] = -y[2]*cos(x[0] + u[8] - y[3]);
out[37] = -sin(x[0] + u[8] - y[3]);
out[38] = y[2]*cos(x[0] + u[8] - y[3]);
out[41] = y[2]*sin(x[0] + u[8] - y[3]);
out[43] = -cos(x[0] + u[8] - y[3]);
out[44] = -y[2]*sin(x[0] + u[8] - y[3]);
out[47] = y[2]*y[5]*cos(x[0] + u[8] - y[3]) - y[2]*y[6]*sin(x[0] + u[8] - y[3]);
out[48] = y[5]*sin(x[0] + u[8] - y[3]) + y[6]*cos(x[0] + u[8] - y[3]);
out[49] = -y[2]*y[5]*cos(x[0] + u[8] - y[3]) + y[2]*y[6]*sin(x[0] + u[8] - y[3]);
out[50] = y[2]*sin(x[0] + u[8] - y[3]);
out[51] = y[2]*cos(x[0] + u[8] - y[3]);
out[53] = -y[2]*y[5]*sin(x[0] + u[8] - y[3]) - y[2]*y[6]*cos(x[0] + u[8] - y[3]);
out[54] = y[5]*cos(x[0] + u[8] - y[3]) - y[6]*sin(x[0] + u[8] - y[3]);
out[55] = y[2]*y[5]*sin(x[0] + u[8] - y[3]) + y[2]*y[6]*cos(x[0] + u[8] - y[3]);
out[56] = y[2]*cos(x[0] + u[8] - y[3]);
out[57] = -y[2]*sin(x[0] + u[8] - y[3]);
out[59] = -22.627416997969522/p[22] - 880.00475747389362*(p[14] - (-0.001*p[14]*p[21]*u[10]*(0.01*p[20]*(u[11] - 25.0) + 1.0) + p[19]*(u[11] - 25.0) + p[17])/p[22])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))*exp(38.89108321788833*(p[21]*y[9] + 22.627416997969522*x[3])/(p[23]*p[18]))/(p[23]*p[18]);
out[60] = -p[21]/p[22] - 1.0 - 38.89108321788833*p[21]*(p[14] - (-0.001*p[14]*p[21]*u[10]*(0.01*p[20]*(u[11] - 25.0) + 1.0) + p[19]*(u[11] - 25.0) + p[17])/p[22])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))*exp(38.89108321788833*(p[21]*y[9] + 22.627416997969522*x[3])/(p[23]*p[18]))/(p[23]*p[18]);
out[63] = y[12]*(pow(sin(y[1]), 2) + pow(cos(y[1]), 2));
out[65] = y[0]*pow(sin(y[1]), 2) + y[0]*pow(cos(y[1]), 2);
out[66] = -y[11]*(pow(sin(y[1]), 2) + pow(cos(y[1]), 2));
out[67] = -y[0]*pow(sin(y[1]), 2) - y[0]*pow(cos(y[1]), 2);
out[71] = -pow(sin(y[1]), 2) - pow(cos(y[1]), 2);
out[75] = -sin(y[1]);
out[76] = -y[0]*cos(y[1]) - y[13]*sin(y[1]) + y[14]*cos(y[1]);
out[77] = cos(y[1]);
out[78] = sin(y[1]);
out[81] = -cos(y[1]);
out[82] = y[0]*sin(y[1]) - y[13]*cos(y[1]) - y[14]*sin(y[1]);
out[83] = -sin(y[1]);
out[84] = cos(y[1]);
out[87] = y[15]*sin(y[1]) + y[16]*cos(y[1]);
out[88] = y[0]*y[15]*cos(y[1]) - y[0]*y[16]*sin(y[1]);
out[89] = y[0]*sin(y[1]);
out[90] = y[0]*cos(y[1]);
out[92] = -y[15]*cos(y[1]) + y[16]*sin(y[1]);
out[93] = y[0]*y[15]*sin(y[1]) + y[0]*y[16]*cos(y[1]);
out[94] = -y[0]*cos(y[1]);
out[95] = y[0]*sin(y[1]);
...
out[3] = -p[11];
out[4] = -p[12];
out[7] = 0.070710678118654752/p[26];
out[12] = -p[32];
out[18] = -1000000.0/p[0];
out[23] = -1000000.0/p[0];
out[28] = -p[6]/p[0];
out[33] = -p[6]/p[0];
out[39] = -p[9];
out[40] = p[8];
...
out[81] = 1.0 - 0.25*Dt*(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/(p[26]*pow(x[3] + 9.9999999999999995e-7, 2));
out[84] = 0.25*Dt*(y[15]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])) + y[16]*(-y[13]*cos(y[1]) - y[14]*sin(y[1])))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[96] = 0.25*Dt*(y[15]*cos(y[1]) - y[16]*sin(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[97] = 0.25*Dt*(y[15]*sin(y[1]) + y[16]*cos(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[98] = 0.25*Dt*(y[13]*cos(y[1]) + y[14]*sin(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[99] = 0.25*Dt*(-y[13]*sin(y[1]) + y[14]*cos(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[135] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[136] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[137] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[138] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[9] = -3.1415926535897931*Dt*p[7];
out[24] = 3.1415926535897931*Dt*p[7];
out[27] = 0.5*Dt*p[11] + 1.0;
out[54] = 0.5*Dt*p[12] + 1.0;
out[92] = -0.035355339059327376*Dt/p[26];
out[108] = 0.5*Dt*p[32] + 1.0;
out[128] = 0.5*Dt;
out[152] = -1000000.0/p[0];
out[179] = -1000000.0/p[0];
out[194] = -p[6]/p[0];
...
out[5] = 1.0 - 0.25*Dt*(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/(p[26]*pow(x[3] + 9.9999999999999995e-7, 2));
out[6] = 0.25*Dt*(y[15]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])) + y[16]*(-y[13]*cos(y[1]) - y[14]*sin(y[1])))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[8] = 0.25*Dt*(y[15]*cos(y[1]) - y[16]*sin(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[9] = 0.25*Dt*(y[15]*sin(y[1]) + y[16]*cos(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[10] = 0.25*Dt*(y[13]*cos(y[1]) + y[14]*sin(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[11] = 0.25*Dt*(-y[13]*sin(y[1]) + y[14]*cos(y[1]))/(p[26]*(x[3] + 9.9999999999999995e-7));
out[14] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[15] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[16] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[17] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[7] = -0.035355339059327376*Dt/p[26];
out[12] = 0.5*Dt*p[32] + 1.0;
out[13] = 0.5*Dt;
out[18] = -1000000.0/p[0];
out[23] = -1000000.0/p[0];
out[28] = -p[6]/p[0];
...
out[181] = 9.9999999999999995e-7*p[14]*p[21]*u[10]*(0.01*p[20]*(u[11] - 25.0) + 1.0)*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))*exp(38.89108321788833*(p[19]*(u[11] - 25.0) + p[17])/(p[23]*p[18]))/p[22] + 0.001*p[14]*p[21]*(1.0 - exp(38.89108321788833*(p[21]*y[9] + 22.627416997969522*x[3])/(p[23]*p[18])))*(0.01*p[20]*(u[11] - 25.0) + 1.0)*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))/p[22] + 0.001*(p[14] - (-0.001*p[14]*p[21]*u[10]*(0.01*p[20]*(u[11] - 25.0) + 1.0) + p[19]*(u[11] - 25.0) + p[17])/p[22])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))*exp(38.89108321788833*(p[19]*(u[11] - 25.0) + p[17])/(p[23]*p[18])) + 0.001*(p[19]*(u[11] - 25.0) + p[17])/p[22];
out[182] = 0.001*u[10]*(p[19]/p[22] - (-1.0000000000000001e-5*p[14]*p[20]*p[21]*u[10] + p[19])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))*exp(38.89108321788833*(p[19]*(u[11] - 25.0) + p[17])/(p[23]*p[18]))/p[22]) - (1.0 - exp(38.89108321788833*(p[21]*y[9] + 22.627416997969522*x[3])/(p[23]*p[18])))*(-1.0000000000000001e-5*p[14]*p[20]*p[21]*u[10] + p[19])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))/p[22] - 38.89108321788833*p[19]*(1.0 - exp(38.89108321788833*(p[21]*y[9] + 22.627416997969522*x[3])/(p[23]*p[18])))*(p[14] - (-0.001*p[14]*p[21]*u[10]*(0.01*p[20]*(u[11] - 25.0) + 1.0) + p[19]*(u[11] - 25.0) + p[17])/p[22])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))/(p[23]*p[18]);
...
out[48] = 22.627416997969522*y[9];
out[83] = -(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/pow(x[3], 2);
out[88] = -sqrt(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2))/pow(x[3], 2);
...
out[63] = -2.0*y[0]*p[2] + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[64] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[65] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[66] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[84] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[85] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[86] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[87] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[105] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[106] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[107] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) - 2.0*y[2]*p[2];
out[108] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[198] = 22.627416997969522*x[3];
out[337] = (y[15]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])) + y[16]*(-y[13]*cos(y[1]) - y[14]*sin(y[1])))/x[3];
out[349] = (y[15]*cos(y[1]) - y[16]*sin(y[1]))/x[3];
out[350] = (y[15]*sin(y[1]) + y[16]*cos(y[1]))/x[3];
out[351] = (y[13]*cos(y[1]) + y[14]*sin(y[1]))/x[3];
out[352] = (-y[13]*sin(y[1]) + y[14]*cos(y[1]))/x[3];
out[358] = (0.5*(-2.0*y[13]*sin(y[1]) + 2.0*y[14]*cos(y[1]))*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + 0.5*(-y[13]*sin(y[1]) + y[14]*cos(y[1]))*(-2.0*y[13]*cos(y[1]) - 2.0*y[14]*sin(y[1])))*pow(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2), -0.5)/x[3];
out[370] = (-(-y[13]*sin(y[1]) + y[14]*cos(y[1]))*sin(y[1]) + (y[13]*cos(y[1]) + y[14]*sin(y[1]))*cos(y[1]))*pow(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2), -0.5)/x[3];
out[371] = ((-y[13]*sin(y[1]) + y[14]*cos(y[1]))*cos(y[1]) + (y[13]*cos(y[1]) + y[14]*sin(y[1]))*sin(y[1]))*pow(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2), -0.5)/x[3];
out[379] = pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2)/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2)) + pow(-y[13]*cos(y[1]) - y[14]*sin(y[1]), 2)/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2));
out[391] = (-y[13]*sin(y[1]) + y[14]*cos(y[1]))*cos(y[1])/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2)) - (-y[13]*cos(y[1]) - y[14]*sin(y[1]))*sin(y[1])/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2));
out[392] = (-y[13]*sin(y[1]) + y[14]*cos(y[1]))*sin(y[1])/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2)) + (-y[13]*cos(y[1]) - y[14]*sin(y[1]))*cos(y[1])/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2));
...
out[10] = 9.9999999999999995e-7*p[14]*p[21]*u[10]*(0.01*p[20]*(u[11] - 25.0) + 1.0)*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))*exp(38.89108321788833*(p[19]*(u[11] - 25.0) + p[17])/(p[23]*p[18]))/p[22] + 0.001*p[14]*p[21]*(1.0 - exp(38.89108321788833*(p[21]*y[9] + 22.627416997969522*x[3])/(p[23]*p[18])))*(0.01*p[20]*(u[11] - 25.0) + 1.0)*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))/p[22] + 0.001*(p[14] - (-0.001*p[14]*p[21]*u[10]*(0.01*p[20]*(u[11] - 25.0) + 1.0) + p[19]*(u[11] - 25.0) + p[17])/p[22])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))*exp(38.89108321788833*(p[19]*(u[11] - 25.0) + p[17])/(p[23]*p[18])) + 0.001*(p[19]*(u[11] - 25.0) + p[17])/p[22];
out[11] = 0.001*u[10]*(p[19]/p[22] - (-1.0000000000000001e-5*p[14]*p[20]*p[21]*u[10] + p[19])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))*exp(38.89108321788833*(p[19]*(u[11] - 25.0) + p[17])/(p[23]*p[18]))/p[22]) - (1.0 - exp(38.89108321788833*(p[21]*y[9] + 22.627416997969522*x[3])/(p[23]*p[18])))*(-1.0000000000000001e-5*p[14]*p[20]*p[21]*u[10] + p[19])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))/p[22] - 38.89108321788833*p[19]*(1.0 - exp(38.89108321788833*(p[21]*y[9] + 22.627416997969522*x[3])/(p[23]*p[18])))*(p[14] - (-0.001*p[14]*p[21]*u[10]*(0.01*p[20]*(u[11] - 25.0) + 1.0) + p[19]*(u[11] - 25.0) + p[17])/p[22])*exp(38.89108321788833*(-p[19]*(u[11] - 25.0) - p[17])/(p[23]*p[18]))/(p[23]*p[18]);
...
out[2] = 22.627416997969522*y[9];
out[3] = -(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/pow(x[3], 2);
out[4] = -sqrt(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2))/pow(x[3], 2);
...
out[18] = 22.627416997969522*x[3];
out[25] = (y[15]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])) + y[16]*(-y[13]*cos(y[1]) - y[14]*sin(y[1])))/x[3];
out[26] = (y[15]*cos(y[1]) - y[16]*sin(y[1]))/x[3];
out[27] = (y[15]*sin(y[1]) + y[16]*cos(y[1]))/x[3];
out[28] = (y[13]*cos(y[1]) + y[14]*sin(y[1]))/x[3];
out[29] = (-y[13]*sin(y[1]) + y[14]*cos(y[1]))/x[3];
out[30] = (0.5*(-2.0*y[13]*sin(y[1]) + 2.0*y[14]*cos(y[1]))*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + 0.5*(-y[13]*sin(y[1]) + y[14]*cos(y[1]))*(-2.0*y[13]*cos(y[1]) - 2.0*y[14]*sin(y[1])))*pow(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2), -0.5)/x[3];
out[31] = (-(-y[13]*sin(y[1]) + y[14]*cos(y[1]))*sin(y[1]) + (y[13]*cos(y[1]) + y[14]*sin(y[1]))*cos(y[1]))*pow(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2), -0.5)/x[3];
out[32] = ((-y[13]*sin(y[1]) + y[14]*cos(y[1]))*cos(y[1]) + (y[13]*cos(y[1]) + y[14]*sin(y[1]))*sin(y[1]))*pow(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2), -0.5)/x[3];
out[33] = pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2)/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2)) + pow(-y[13]*cos(y[1]) - y[14]*sin(y[1]), 2)/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2));
out[34] = (-y[13]*sin(y[1]) + y[14]*cos(y[1]))*cos(y[1])/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2)) - (-y[13]*cos(y[1]) - y[14]*sin(y[1]))*sin(y[1])/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2));
out[35] = (-y[13]*sin(y[1]) + y[14]*cos(y[1]))*sin(y[1])/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2)) + (-y[13]*cos(y[1]) - y[14]*sin(y[1]))*cos(y[1])/(pow(-y[13]*sin(y[1]) + y[14]*cos(y[1]), 2) + pow(y[13]*cos(y[1]) + y[14]*sin(y[1]), 2));
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_pv_1_test_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_pv_1_test_cffi(void) { return NULL; }
#  else
     initpv_1_test_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_pv_1_test_cffi(void)
{
  return _cffi_init("pv_1_test_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initpv_1_test_cffi(void)
{
  _cffi_init("pv_1_test_cffi", 0x2601, &_cffi_type_context);
}
#endif
