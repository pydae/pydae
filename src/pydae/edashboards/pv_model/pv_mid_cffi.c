...
out[1] = -x[1]*p[11] + u[4];
out[2] = -x[2]*p[12] + u[9];
out[3] = (0.00028284271247461902*p[15]*y[9] - 0.5*(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/(x[3] + 9.9999999999999995e-7))/p[29];
out[4] = -p[35]*x[4] - y[19] + 1;
...
out[9] = (1.0/1000.0)*p[16]*u[10]*((1.0/100.0)*p[22]*(u[11] - 25.0) + 1) - y[9] - (p[16]*((1.0/100.0)*p[22]*(u[11] - 25.0) + 1) - (-p[16]*p[23]*((1.0/100.0)*p[22]*(u[11] - 25.0) + 1) + p[19]*(0.01*p[21]*(u[11] - 25.0) + 1))/p[24])*(exp(38.89108321788833*(p[23]*y[9] + 565.68542494923804*x[3]/p[14])/(p[25]*p[20])) - 1)*exp(-38.89108321788833*p[19]*(0.01*p[21]*(u[11] - 25.0) + 1)/(p[25]*p[20])) - (p[23]*y[9] + 565.68542494923804*x[3]/p[14])/p[24];
out[10] = -p[26]*(-x[3] + u[12]) - y[10];
out[11] = y[12]*(y[0]*pow(sin(y[1]), 2) + y[0]*pow(cos(y[1]), 2)) - y[10];
out[12] = -y[11]*(y[0]*pow(sin(y[1]), 2) + y[0]*pow(cos(y[1]), 2)) - u[13];
out[13] = -p[27]*(u[15] + y[11]) - p[28]*(u[16] + y[12]) + y[13];
out[14] = -p[27]*(u[16] + y[12]) - y[0]*pow(sin(y[1]), 2) - y[0]*pow(cos(y[1]), 2) + p[28]*(u[15] + y[11]) + y[14];
out[15] = -p[27]*y[15] - y[0]*sin(y[1]) - p[28]*y[16] + y[13]*cos(y[1]) + y[14]*sin(y[1]);
out[16] = -p[27]*y[16] - y[0]*cos(y[1]) + p[28]*y[15] - y[13]*sin(y[1]) + y[14]*cos(y[1]);
out[17] = y[0]*y[15]*sin(y[1]) + y[0]*y[16]*cos(y[1]) - y[17];
out[18] = -y[0]*y[15]*cos(y[1]) + y[0]*y[16]*sin(y[1]) - y[18];
out[19] = 1.0*y[4] - y[19];
out[20] = p[34]*x[4] + p[33]*(1 - y[19]) - y[20];
...
out[6] = u[4];
out[7] = x[2];
out[8] = 565.68542494923804*x[3]/p[14];
out[9] = 565.68542494923804*y[9]*x[3]/p[14];
out[10] = u[15] + y[11];
out[11] = u[16] + y[12];
out[12] = y[17];
out[13] = y[18];
...
out[19] = 0.00056568542494923803*p[15]*y[9];
out[20] = p[15]*y[9];

}
void de_jac_ini_xy_eval(double *out,double *x,double *y,double *u,double *p,double Dt){

out[81] = 0.5*(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/(p[29]*pow(x[3] + 9.9999999999999995e-7, 2));
out[84] = -0.5*(y[15]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])) + y[16]*(-y[13]*cos(y[1]) - y[14]*sin(y[1])))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[96] = -0.5*(y[15]*cos(y[1]) - y[16]*sin(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[97] = -0.5*(y[15]*sin(y[1]) + y[16]*cos(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[98] = -0.5*(y[13]*cos(y[1]) + y[14]*sin(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[99] = -0.5*(-y[13]*sin(y[1]) + y[14]*cos(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
...
out[367] = -565.68542494923804/(p[14]*p[24]) - 22000.118936847339*(p[16]*(0.01*p[22]*(u[11] - 25.0) + 1.0) - (-p[16]*p[23]*(0.01*p[22]*(u[11] - 25.0) + 1.0) + p[19]*(0.01*p[21]*(u[11] - 25.0) + 1.0))/p[24])*exp(38.89108321788833*(p[23]*y[9] + 565.68542494923804*x[3]/p[14])/(p[25]*p[20]))*exp(-38.89108321788833*p[19]*(0.01*p[21]*(u[11] - 25.0) + 1)/(p[25]*p[20]))/(p[25]*p[14]*p[20]);
out[378] = -p[23]/p[24] - 1.0 - 38.89108321788833*p[23]*(p[16]*(0.01*p[22]*(u[11] - 25.0) + 1.0) - (-p[16]*p[23]*(0.01*p[22]*(u[11] - 25.0) + 1.0) + p[19]*(0.01*p[21]*(u[11] - 25.0) + 1.0))/p[24])*exp(38.89108321788833*(p[23]*y[9] + 565.68542494923804*x[3]/p[14])/(p[25]*p[20]))*exp(-38.89108321788833*p[19]*(0.01*p[21]*(u[11] - 25.0) + 1)/(p[25]*p[20]))/(p[25]*p[20]);
...
out[27] = -p[11];
out[54] = -p[12];
out[92] = 0.00028284271247461902*p[15]/p[29];
out[108] = -p[35];
...
out[5] = 0.5*(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/(p[29]*pow(x[3] + 9.9999999999999995e-7, 2));
out[6] = -0.5*(y[15]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])) + y[16]*(-y[13]*cos(y[1]) - y[14]*sin(y[1])))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[8] = -0.5*(y[15]*cos(y[1]) - y[16]*sin(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[9] = -0.5*(y[15]*sin(y[1]) + y[16]*cos(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[10] = -0.5*(y[13]*cos(y[1]) + y[14]*sin(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[11] = -0.5*(-y[13]*sin(y[1]) + y[14]*cos(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
...
out[59] = -565.68542494923804/(p[14]*p[24]) - 22000.118936847339*(p[16]*(0.01*p[22]*(u[11] - 25.0) + 1.0) - (-p[16]*p[23]*(0.01*p[22]*(u[11] - 25.0) + 1.0) + p[19]*(0.01*p[21]*(u[11] - 25.0) + 1.0))/p[24])*exp(38.89108321788833*(p[23]*y[9] + 565.68542494923804*x[3]/p[14])/(p[25]*p[20]))*exp(-38.89108321788833*p[19]*(0.01*p[21]*(u[11] - 25.0) + 1)/(p[25]*p[20]))/(p[25]*p[14]*p[20]);
out[60] = -p[23]/p[24] - 1.0 - 38.89108321788833*p[23]*(p[16]*(0.01*p[22]*(u[11] - 25.0) + 1.0) - (-p[16]*p[23]*(0.01*p[22]*(u[11] - 25.0) + 1.0) + p[19]*(0.01*p[21]*(u[11] - 25.0) + 1.0))/p[24])*exp(38.89108321788833*(p[23]*y[9] + 565.68542494923804*x[3]/p[14])/(p[25]*p[20]))*exp(-38.89108321788833*p[19]*(0.01*p[21]*(u[11] - 25.0) + 1)/(p[25]*p[20]))/(p[25]*p[20]);
...
out[3] = -p[11];
out[4] = -p[12];
out[7] = 0.00028284271247461902*p[15]/p[29];
out[12] = -p[35];
...
out[81] = 1.0 - 0.25*Dt*(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/(p[29]*pow(x[3] + 9.9999999999999995e-7, 2));
out[84] = 0.25*Dt*(y[15]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])) + y[16]*(-y[13]*cos(y[1]) - y[14]*sin(y[1])))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[96] = 0.25*Dt*(y[15]*cos(y[1]) - y[16]*sin(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[97] = 0.25*Dt*(y[15]*sin(y[1]) + y[16]*cos(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[98] = 0.25*Dt*(y[13]*cos(y[1]) + y[14]*sin(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[99] = 0.25*Dt*(-y[13]*sin(y[1]) + y[14]*cos(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[135] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[136] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[137] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[138] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[92] = -0.00014142135623730951*Dt*p[15]/p[29];
out[108] = 0.5*Dt*p[35] + 1.0;
out[128] = 0.5*Dt;
out[152] = -1000000.0/p[0];
out[179] = -1000000.0/p[0];
out[194] = -p[6]/p[0];
...
out[5] = 1.0 - 0.25*Dt*(y[15]*(y[13]*cos(y[1]) + y[14]*sin(y[1])) + y[16]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])))/(p[29]*pow(x[3] + 9.9999999999999995e-7, 2));
out[6] = 0.25*Dt*(y[15]*(-y[13]*sin(y[1]) + y[14]*cos(y[1])) + y[16]*(-y[13]*cos(y[1]) - y[14]*sin(y[1])))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[8] = 0.25*Dt*(y[15]*cos(y[1]) - y[16]*sin(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[9] = 0.25*Dt*(y[15]*sin(y[1]) + y[16]*cos(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[10] = 0.25*Dt*(y[13]*cos(y[1]) + y[14]*sin(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[11] = 0.25*Dt*(-y[13]*sin(y[1]) + y[14]*cos(y[1]))/(p[29]*(x[3] + 9.9999999999999995e-7));
out[14] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[15] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[16] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[17] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
...
out[7] = -0.00014142135623730951*Dt*p[15]/p[29];
out[12] = 0.5*Dt*p[35] + 1.0;
out[13] = 0.5*Dt;
out[18] = -1000000.0/p[0];
out[23] = -1000000.0/p[0];
out[28] = -p[6]/p[0];
...
out[182] = 1.0000000000000001e-5*p[16]*p[22]*u[10] + (1.0 - exp(38.89108321788833*(p[23]*y[9] + 565.68542494923804*x[3]/p[14])/(p[25]*p[20])))*(0.01*p[16]*p[22] - (-0.01*p[16]*p[22]*p[23] + 0.01*p[21]*p[19])/p[24])*exp(-38.89108321788833*p[19]*(0.01*p[21]*(u[11] - 25.0) + 1)/(p[25]*p[20])) - 0.38891083217888328*p[21]*p[19]*(1.0 - exp(38.89108321788833*(p[23]*y[9] + 565.68542494923804*x[3]/p[14])/(p[25]*p[20])))*(p[16]*(0.01*p[22]*(u[11] - 25.0) + 1.0) - (-p[16]*p[23]*(0.01*p[22]*(u[11] - 25.0) + 1.0) + p[19]*(0.01*p[21]*(u[11] - 25.0) + 1.0))/p[24])*exp(-38.89108321788833*p[19]*(0.01*p[21]*(u[11] - 25.0) + 1)/(p[25]*p[20]))/(p[25]*p[20]);
...
out[40] = -1/p[0];
out[60] = -1/p[0];
out[181] = 0.001*p[16]*(0.01*p[22]*(u[11] - 25.0) + 1.0);
out[202] = -p[26];
out[262] = -p[27];
out[263] = -p[28];
out[281] = p[28];
...
out[48] = 565.68542494923804*y[9]/p[14];
...
out[43] = 565.68542494923804/p[14];
...
out[198] = 565.68542494923804*x[3]/p[14];
...
out[408] = 0.00056568542494923803*p[15];
out[429] = p[15];
...
out[11] = 1.0000000000000001e-5*p[16]*p[22]*u[10] + (1.0 - exp(38.89108321788833*(p[23]*y[9] + 565.68542494923804*x[3]/p[14])/(p[25]*p[20])))*(0.01*p[16]*p[22] - (-0.01*p[16]*p[22]*p[23] + 0.01*p[21]*p[19])/p[24])*exp(-38.89108321788833*p[19]*(0.01*p[21]*(u[11] - 25.0) + 1)/(p[25]*p[20])) - 0.38891083217888328*p[21]*p[19]*(1.0 - exp(38.89108321788833*(p[23]*y[9] + 565.68542494923804*x[3]/p[14])/(p[25]*p[20])))*(p[16]*(0.01*p[22]*(u[11] - 25.0) + 1.0) - (-p[16]*p[23]*(0.01*p[22]*(u[11] - 25.0) + 1.0) + p[19]*(0.01*p[21]*(u[11] - 25.0) + 1.0))/p[24])*exp(-38.89108321788833*p[19]*(0.01*p[21]*(u[11] - 25.0) + 1)/(p[25]*p[20]))/(p[25]*p[20]);
...
out[2] = -1/p[0];
out[3] = -1/p[0];
out[10] = 0.001*p[16]*(0.01*p[22]*(u[11] - 25.0) + 1.0);
out[12] = -p[26];
out[14] = -p[27];
out[15] = -p[28];
out[16] = p[28];
...
out[2] = 565.68542494923804*y[9]/p[14];
...
out[18] = 565.68542494923804*x[3]/p[14];
...
out[36] = 0.00056568542494923803*p[15];
out[37] = p[15];
